package
{
   ...
   public class class_2
   {
      ...
      private static var instance:class_2;
      
      private static var mRef:class_79;
      
      private static var var_255:Boolean = false;
      
      private static var var_230:Boolean = false;
      
      public var var_48:Array;
      
      public var var_83:Array;
      
      public var var_12:Array;
      
      public var var_172:Array;
      
      private var var_102:int;
      
      public var arrClassData:Array;
      
      public var var_50:Array;
      
      public var var_569:Array;
      
      private var var_104:int;
      
      public var var_62:Array;
      ...
      public static function method_592(param1:class_79) : *
      {
         if(!var_230)
         {
            mRef = param1;
      ...
      public static function method_64() : class_79
      {
         if(var_230)
         {
            return mRef;
      ...
      public static function getInstance() : class_2
      {
         if(!instance)
         {
            var_255 = true;
      ...
      public function method_714() : void
      {
         ...
         this.var_83.push({
            ...
            "strDamageText":"",
            "strSummaryText":"",
            "strFlavorText":"The Medium Bubble is very similar to the Small Bubble, but slightly larger.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_83.push({
         ...
         this.var_83.push({
            ...
            "strDamageText":"",
            "strSummaryText":"",
            "strFlavorText":"Huge Bubble\'s size is kinda too big, however for some tanks it is acceptable.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_83.push({
         ...
         this.var_50.push({
            ...
            "strFlavorText":"The Basic Cannon is unwavering its determination to smite enemies.  It may not look like much, but it gets the job done.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_50.push({
         ...
         this.var_50.push({
            ...
            "strFlavorText":"The Duel Large Machine Gun is so powerful that many people don\'t believe it even exists!  A weapon of legend, we think you\'ll like having it on your tank.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_50.push({
            ...
            "strFlavorText":"The 2 Parallel is an awesome weapon with its 2 focused bullets.  Honestly, what CAN\'T it do? \"Fire 3 bullets,\" says 3 Parallel.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_50.push({
         ...
         this.var_50.push({
            ...
            "strFlavorText":"Bullet Buster is a lover, not a fighter.  Says Bullet Buster: \"We\'re just a bunch of bubbles anyways, what\'s with all the violence?\"",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_50.push({
         ...
         this.var_62.push({
            ...
            "strFlavorText":"Do Bubble Tanks have brains?  Maybe they have drivers?  Not sure, but somehow this weapon is able to stun those tanks really well.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_62.push({
            ...
            "strFlavorText":"For those who want an up close and personal battle and are looking for that more intimate fighting, the Area Burst is for you.  Just fly into a group of enemies and let loose.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_62.push({
         ...
         this.var_62.push({
            ...
            "strFlavorText":"This is the gun all other Bubble Tanks weapons aspire to be.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_62.push({
         ...
         this.var_48.push({
            ...
            "strFlavorText":"This is the standard gun on most bad guys. Looks simple, but when facing a few enemies with this guy it can get tough quick.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_48.push({
         ...
         this.var_48.push({
            ...
            "strFlavorText":"Taking up the family business of attacking tanks is fine and good, but Enemy Spawner would love to have at least one kid be a doctor.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_48.push({
         ...
         this.var_48.push({
            ...
            "strFlavorText":"This weapon is great for kids not ready for the 5 Parallel experience yet.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_48.push({
         ...
         this.var_48.push({
            ...
            "strFlavorText":"Don\'t hate on the 360\'s general lack of aiming skill. 4 out of 5 dentists agree: this gun is going to hit you.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_48.push({
         ...
         this.var_48.push({
            ...
            "strFlavorText":"Don\'t mock the fact that this weapon freaks out and shoots everywhere, this is the gun that makes many BTA players break down and cry.",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_48.push({
            ...
            "strFlavorText":"Making more destructive bubble weapons is a careful and precise science few can comprehend.  This gun shoots bigger bullets!",
            "intLocked":1,
            "blnAfford":true
         });
         this.var_48.push({
      ...
      public function method_87(param1:int, param2:Boolean = false) : String
      {
      ...
      public function method_614(param1:int, param2:Boolean = false) : String
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function method_166(param1:int, param2:Boolean = false) : int
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function method_26(param1:int, param2:Boolean = false) : String
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function method_606(param1:int, param2:Boolean = false) : String
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function GetClassData(param1:int) : Object
      {
         this.arrClassData.push({
            "intClass":6,
            "intArmor":3,
      ...
      public function method_149(param1:int, param2:Boolean = false) : int
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function method_207(param1:int, param2:Boolean = false) : int
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function method_535(param1:int, param2:Boolean = false) : String
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function method_37(param1:int, param2:Boolean = false) : String
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
      ...
      public function method_123(param1:int, param2:Boolean = false) : MovieClip
      {
         var _loc4_:uint = 0;
      ...
      public function GetObjectType(param1:int) : int
      {
         return Math.floor(param1 / 1000);
      }
      
      public function IsObjectAWeapon(param1:int) : Boolean
      {
         if(param1 >= 1000 && param1 <= 1999)
         {
            return false;
      ...
      private function method_71(param1:int, param2:Boolean = false) : Object
      {
         var _loc4_:uint = 0;
         null;
         if(param1 != this.var_102)
      ...
      public function method_240(param1:int, param2:Boolean = false) : Boolean
      {
         var var_40:int = param1;
         var var_56:Boolean = param2;
         try
