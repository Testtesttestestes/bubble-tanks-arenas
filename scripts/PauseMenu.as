package
{
   ...
   public class PauseMenu extends Sprite
   {
      ...
      internal var var_187:Number = 0;
      
      internal var var_45:Array;
      
      internal var var_439:Sprite;
      
      internal var var_8:class_3;
      
      internal var objHotkeyManager:class_4;
      
      internal var arenaProgressButtonManager:class_3;
      
      internal var var_114:Array;
      
      internal var var_69:Array;
      
      internal var var_16:Array;
      
      internal var var_580:Number = 0;
      
      internal var var_284:Number = 0;
      
      internal var var_442:Number = 0;
      
      internal var var_1:PausedMenuButtons;
      
      internal var btaGameWorld:BTAGameWorld;
      
      internal var var_74:Array;
      
      internal var var_65:Array;
      
      internal var settingsButtonManager:class_3;
      
      internal var var_123:class_51;
      
      internal var var_68:Array;
      
      internal var var_63:Array;
      
      internal var intState:Number = 0;
      
      internal var arrBubbleFields:Array;
      
      internal var var_204:Array;
      
      internal var var_274:Boolean;
      
      internal var var_315:class_3;
      
      internal var objGameObjectLibrary:class_2;
      
      internal var var_318:class_3;
      
      public function PauseMenu(param1:BTAGameWorld = null)
      {
         var _loc2_:uint = 0;
         var _loc3_:class_51 = null;
      ...
      private function method_658() : void
      {
         var _loc1_:uint = 0;
      ...
      private function method_443() : void
      {
      ...
      private function method_458() : void
      {
      ...
      private function method_511() : void
      {
         if(this.var_1.BlankArena_mc.active)
         {
      ...
      private function BtnUp(param1:Event) : void
      {
         param1.target.OverMe = false;
         this.var_1.rollover_txt.text = "";
      ...
      private function BtnSettingsUp(param1:Event) : void
      {
         param1.target.OverMe = false;
         this.var_1.rollover_txt.text = "";
      ...
      private function method_167() : void
      {
      ...
      private function method_563(param1:Event) : void
      {
         param1.target.OverMe = false;
         this.var_1.rollover_txt.text = "";
      ...
      private function method_695() : void
      {
      ...
      private function method_768() : void
      {
      ...
      private function method_524() : void
      {
         ...
         var _loc2_:Object = this.method_496(_loc1_.arrTankDetails);
      ...
      private function BtnKeyboardUp(param1:Event) : void
      {
         param1.target.OverMe = false;
         this.var_1.rollover_txt.text = "";
      ...
      private function method_153() : void
      {
         if(this.var_274)
         {
      ...
      private function method_633() : void
      {
      ...
      private function method_648() : void
      {
         if(this.btaGameWorld.var_71 != -1)
         {
            ...
            var _temp_3:* = this.var_63[this.btaGameWorld.var_71];
            var _temp_2:* = this.var_63[this.btaGameWorld.var_71];
            var _temp_1:* = 40;
            40;
      ...
      private function method_702(param1:Event) : void
      {
         param1.target.OverMe = false;
         this.var_1.rollover_txt.text = "";
