package package_7
{
   public class SHA256 extends class_31 implements class_17
   {
      ...
      protected function method_79(param1:uint, param2:uint) : uint
      {
      ...
      override protected function core(param1:Array, param2:uint) : Array
      {
         ...
         while(0 < param1.length)
         {
            ...
            while(_loc21_ < 64)
            {
               ...
               {
                  _loc24_ = uint(this.method_79(_loc3_[_loc21_ - 15],7) ^ this.method_79(_loc3_[_loc21_ - 15],18) ^ _loc3_[_loc21_ - 15] >>> 3);
                  _loc25_ = uint(this.method_79(_loc3_[_loc21_ - 2],17) ^ this.method_79(_loc3_[_loc21_ - 2],19) ^ _loc3_[_loc21_ - 2] >>> 10);
