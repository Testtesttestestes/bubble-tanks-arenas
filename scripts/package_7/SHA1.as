package package_7
{
   public class SHA1 extends class_31 implements class_17
   {
      
      public static const const_8:int = 20;
      ...
      override protected function core(param1:Array, param2:uint) : Array
      {
         ...
         while(0 < param1.length)
         {
            ...
            _loc7_ += _loc13_;
            _loc8_ += _loc14_;
            var _loc9_:uint = 0 + 16;
         }
         return [_loc4_,_loc5_,_loc6_,_loc7_,_loc8_];
      }
      
      private function method_512(param1:uint) : uint
      {
      ...
      private function method_639(param1:uint, param2:uint, param3:uint, param4:uint) : uint
      {
         if(param1 < 20)
         {
