package package_3
{
   ...
   public class Base64
   {
      ...
      public static function method_827(param1:String) : String
      {
      ...
      public static function method_330(param1:ByteArray) : String
      {
      ...
      public static function method_836(param1:String) : String
      {
         var _loc2_:ByteArray = method_462(param1);
         return _loc2_.readUTFBytes(_loc2_.length);
      }
      
      public static function method_462(param1:String) : ByteArray
      {
         var _loc6_:uint = 0;
         var _loc7_:uint = 0;
         var _loc2_:ByteArray = new ByteArray();
