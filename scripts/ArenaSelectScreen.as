package
{
   ...
   public class ArenaSelectScreen extends MovieClip
   {
      ...
      private var var_256:Number;
      
      private var var_362:Number;
      
      private var var_52:Array;
      
      private var numSlot2:Number;
      
      private var arrSingleArenaID:Array;
      
      private var numSlot3:Number;
      ...
      private var arenaCompleteTextCounterDelay:int;
      
      private var var_36:Number;
      
      private var var_380:int;
      
      private var var_112:Array;
      
      private var objButtonController2:class_3;
      
      private var var_9:Array;
      ...
      private var blnSingleIDSearch:Boolean;
      
      public var var_109:MovieClip;
      
      private var var_143:Array;
      
      private var blnHeroSeverDown:Boolean;
      
      private var var_312:Boolean;
      
      private var var_363:MovieClip;
      
      private var objButtonController:class_3;
      
      private var blnSelectNewProfile:Boolean;
      
      private var var_340:Boolean;
      
      private var blnRefreshServerLevelsOnSearch:Boolean;
      
      public var var_19:MovieClip;
      
      private var var_423:MovieClip;
      
      private var var_457:Array;
      
      private var var_216:Number;
      
      private var strSelectedArenaName:String;
      
      private var var_135:Number;
      
      private var var_32:Number;
      
      private var arrSearchSorts:Array;
      
      private var strCurrentLevelType:String;
      
      private var var_576:Boolean;
      
      private var numStartSection:Number;
      ...
      public var aSlot:MovieClip;
      
      public function ArenaSelectScreen()
      {
         super();
      ...
      private function btnUp2(param1:MouseEvent) : void
      {
      ...
      public function SwitchLevelType(param1:String, param2:Boolean = false) : void
      {
      ...
      private function method_209(param1:Array, param2:Array) : void
      {
         ...
         var var_562:String;
         var var_587:String;
         var var_549:Array = null;
         var var_262:Array = param1;
         var var_56:Array = param2;
         var var_106:String = "";
         var var_194:String = "";
         var var_307:Array = new Array();
         var var_40:Array = new Array();
         var var_346:uint = 0;
      ...
      private function method_178(param1:FocusEvent) : void
      {
         param1.target.text = "";
         param1.target.removeEventListener(FocusEvent.FOCUS_IN,this.method_178);
      }
      ...
      private function method_685() : void
      {
         if(this.var_256 > 0)
         {
            --this.var_256;
      ...
      private function method_287() : void
      {
      ...
      private function btnOut2(param1:MouseEvent) : void
      {
      ...
      public function SearchArenas(param1:String = "") : void
      {
      ...
      public function SearchMenu() : void
      {
         ...
         this.inner.search_sort_mc.name_txt.addEventListener(FocusEvent.FOCUS_IN,this.method_178);
         this.inner.search_sort_mc.author_txt.addEventListener(FocusEvent.FOCUS_IN,this.method_178);
      }
      
      private function scrollBarUp(param1:MouseEvent) : void
      {
         this.var_152 = false;
      }
      
      private function method_264(param1:uint, param2:Boolean = false) : void
      {
         var _loc3_:uint = 0;
         var _loc4_:uint = 0;
         param1--;
      ...
      private function btnOver(param1:MouseEvent) : void
      {
         ...
         else if(param1.target.name.substr(0,5) == "aSlot")
         {
            ...
            while(_loc5_ < this.var_9.length)
            {
               ...
               {
                  this.inner.right_box.arenaSlotLoader.setChildIndex(MovieClip(param1.target),this.inner.right_box.arenaSlotLoader.numChildren - 1);
      ...
      private function method_408(param1:Boolean) : void
      {
         if(param1 == false)
         {
      ...
      public function SelectArena(param1:Number) : void
      {
         this.mRef.gData.var_189 = this.var_112;
         this.mRef.SaveGameData();
         var _loc4_:ArenaData = new ArenaData();
         ...
         if(this.strCurrentLevelType == "bta")
         {
            if(this.mRef.gData.var_14[param1 - 1] != null)
            {
               if(this.mRef.blnBTAUnlocked == true || this.mRef.gData.var_14[param1 - 1].blnLocked == false)
               {
                  ...
                  var _loc2_:String = this.mRef.gData.var_14[param1 - 1].ID;
                  var _loc8_:String = this.mRef.gData.var_14[param1 - 1].AllTanks;
                  var _loc9_:uint = 0;
                  while(0 < "".length)
                  {
                     if("".substr(0,1) != ",")
      ...
      public function ValidateArenaID(param1:String) : void
      {
      ...
      public function Setup(param1:class_79, param2:Function, param3:Number = 1, param4:Boolean = false) : void
      {
         this.mRef = param1;
         this.var_203 = param2;
      ...
      private function ArenaNOTApproved() : void
      {
      ...
      private function method_210(param1:MovieClip, param2:uint = 0) : void
      {
         var _loc7_:uint = 0;
         ...
         var _loc16_:int = 0;
         var _loc17_:int = 0;
         var _loc3_:ArenaData = new ArenaData();
         ...
         else if(this.strCurrentLevelType == "local")
         {
            ...
            if(_loc12_ == false)
            {
               ...
               while(_loc6_ < _loc3_.var_6.length)
               {
                  ...
                  {
                     _loc17_ = int(_loc3_.var_6[_loc6_].arrEnemies[_loc5_].number);
                     _loc16_ += _loc17_;
                     _loc5_++;
                  }
                  _loc6_++;
      ...
      private function tut2Up(param1:MouseEvent) : void
      {
      ...
      private function method_391(param1:String, param2:Number) : void
      {
         var var_40:String;
         var var_56:class_12;
         var var_106:String;
      ...
      private function method_719() : void
      {
         var _loc1_:int = 0;
         var _loc2_:uint = 0;
         if(this.strCurrentLevelType == "bta")
      ...
      private function method_260(param1:Number) : void
      {
         this.mRef.gData.var_189 = this.var_112;
         this.mRef.SaveGameData();
      ...
      private function method_608() : void
      {
         ...
         if(this.var_152 == true)
         {
            ...
            this.inner.right_box.arenaSlotLoader.y = int(32 - this.var_362 * _loc2_);
         }
      }
      
      private function method_356() : void
      {
      ...
      private function method_728() : void
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         var _loc4_:uint = 0;
         ...
         if(this.strCurrentLevelType == "bta")
         {
            ...
            this.inner.right_box.scrollBar.addEventListener(MouseEvent.MOUSE_DOWN,this.scrollBarDown);
            addEventListener(MouseEvent.MOUSE_UP,this.stageUp);
         ...
         else if(this.strCurrentLevelType == "server")
         {
            ...
            this.objButtonController.method_7(this.inner.right_box.downArrow_mc);
            this.objButtonController.method_7(this.inner.right_box.scrollBar);
            this.inner.right_box.scrollBar.removeEventListener(MouseEvent.MOUSE_DOWN,this.scrollBarDown);
            this.objButtonController.method_7(this.inner.right_box.page_up_btn);
            this.objButtonController.method_7(this.inner.right_box.page_down_btn);
            this.objButtonController.method_7(this.inner.right_box.page_top_btn);
            this.objButtonController.method_7(this.inner.right_box.load_ID);
            this.inner.removeEventListener(MouseEvent.MOUSE_UP,this.btnUp);
            this.inner.right_box.arenaSlotLoader.x = 8;
            this.inner.right_box.no_local_found.alpha = 0;
            if(this.var_52.length != 0)
            {
               ...
               this.objButtonController.method_4(this.inner.right_box.load_ID);
               this.inner.right_box.load_id_txt.addEventListener(FocusEvent.FOCUS_IN,this.method_178);
            }
            else
            {
      ...
      private function PullInProfileTankData() : void
      {
         ...
         {
            var _temp_4:* = this.var_109;
            var _temp_3:* = this.var_109;
            var _temp_2:* = 1;
            1;
      ...
      private function method_755(param1:MouseEvent) : void
      {
      ...
      private function ArenaApproved(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         this.inner.slot_cover.gotoAndStop("off");
      ...
      private function ArenasCompletedTextControl() : void
      {
      ...
      private function method_186(param1:String) : void
      {
         var _loc2_:Number = 0;
         var _loc3_:Number = 0;
         if(param1 == "up")
         ...
         var _loc4_:int = 32 - this.var_362 * _loc3_;
         this.inner.right_box.arenaSlotLoader.y = _loc4_;
      }
      
      private function ChangeProfile(param1:Number) : void
      {
         ...
         stage.addEventListener(MouseEvent.MOUSE_WHEEL,this.method_755);
         this.inner.right_box.rightWhite.gotoAndPlay("flash");
      ...
      private function method_763(param1:String) : void
      {
         0;
      ...
      private function scrollBarDown(param1:MouseEvent) : void
      {
         this.var_152 = true;
      }
      ...
      private function method_278(param1:Event) : void
      {
         ...
         for each(var_150 in var_40.ARENA)
         {
      ...
      private function RateArena(param1:Number, param2:Number) : void
      {
         var _loc3_:uint = 0;
      ...
      private function btnOver2(param1:MouseEvent) : void
      {
         if(param1.target.currentFrame != 3)
         {
            param1.target.gotoAndStop("on");
