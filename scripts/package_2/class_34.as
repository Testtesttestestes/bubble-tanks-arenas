package package_2
{
   ...
   public class class_34 implements class_18
   {
      
      private static const const_28:Array = [1,35,69,103,137,171,205,239,254,220,186,152,118,84,50,16,137,171,205,239,1,35,69,103];
      
      private static const const_18:Array = [128,64,32,16,8,4,2,1];
      
      private static const const_15:Array = [8388608,4194304,2097152,1048576,524288,262144,131072,65536,32768,16384,8192,4096,2048,1024,512,256,128,64,32,16,8,4,2,1];
      ...
      protected var var_73:ByteArray;
      
      protected var var_246:Array;
      
      public function class_34(param1:ByteArray)
      {
         super();
         this.var_73 = param1;
      ...
      protected function method_67(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         var _loc7_:uint = 0;
         var _loc10_:uint = 0;
         var _loc11_:uint = 0;
