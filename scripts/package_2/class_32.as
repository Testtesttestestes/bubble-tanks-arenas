package package_2
{
   ...
   public class class_32 implements class_18
   {
      ...
      private static var var_89:ByteArray = new ByteArray();
      
      private static var var_88:ByteArray = new ByteArray();
      
      private static var var_85:ByteArray = new ByteArray();
      ...
      private var var_29:ByteArray;
      
      private var var_221:uint;
      
      private var var_412:uint;
      
      private var var_73:ByteArray;
      
      public function class_32(param1:ByteArray)
      {
         super();
      ...
      protected function method_619() : void
      {
         var _loc1_:uint = 0;
      ...
      protected function method_528() : void
      {
         var _loc1_:uint = 0;
      ...
      {
         var _loc1_:uint = 0;
         var _loc2_:class_26 = new class_26();
         _loc1_ = 0;
      ...
      private function method_645() : void
      {
         ...
         var _loc5_:uint = 0;
         var _loc6_:uint = 0;
         var _loc7_:uint = this.var_73.length / 4;
         ...
         while(_loc6_ < const_10 * (this.var_221 + 1))
         {
            ...
            {
               _loc5_ = _loc4_;
               _loc4_ = uint(var_17[_loc1_]);
               _loc1_ = uint(var_17[_loc2_] ^ Rcon[_loc6_ / _loc7_]);
               _loc2_ = uint(var_17[_loc3_]);
               _loc3_ = uint(var_17[_loc5_]);
            }
            else if(_loc7_ > 6 && _loc6_ % _loc7_ == 4)
            {
               _loc1_ = uint(var_17[_loc1_]);
               _loc2_ = uint(var_17[_loc2_]);
               _loc3_ = uint(var_17[_loc3_]);
               _loc4_ = uint(var_17[_loc4_]);
            }
      ...
      protected function method_196(param1:ByteArray, param2:uint) : void
      {
         var _loc3_:uint = 0;
         _loc3_ = 0;
         while(_loc3_ < 16)
      ...
      protected function method_499() : void
      {
         this.var_29.length = 0;
      ...
      protected function method_602() : void
      {
         var _loc1_:uint = 0;
