   ...
   public class FocusManager implements IFocusManager
   {
      ...
      private function getIndexOfNextObject(param1:int, param2:Boolean, param3:Boolean, param4:String) : int
      {
         ...
         while(true)
         {
            ...
            {
               var _loc7_:DisplayObject = DisplayObject(findFocusManagerComponent(focusableCandidates[param1]));
               if(_loc7_ is IFocusManagerGroup)
               {
                  var _loc8_:IFocusManagerGroup = IFocusManagerGroup(null);
                  var _loc9_:int = 0;
                  while(0 < focusableCandidates.length)
                  {
                     var _loc10_:DisplayObject = focusableCandidates[0];
                     if(_loc10_ is IFocusManagerGroup)
                     {
                        var _loc11_:IFocusManagerGroup = IFocusManagerGroup(null);
      ...
      private function isValidFocusCandidate(param1:DisplayObject, param2:String) : Boolean
      {
         ...
         {
            var _loc3_:IFocusManagerGroup = IFocusManagerGroup(param1);
      ...
      private function isEnabledAndVisible(param1:DisplayObject) : Boolean
      {
         ...
         while(param1 != _loc2_)
         {
            ...
            {
               var _loc3_:TextField = TextField(param1);
            ...
            {
               var _loc4_:SimpleButton = SimpleButton(param1);
               if(!_loc4_.enabled)
               {
                  return false;
               }
      ...
      private function focusInHandler(param1:FocusEvent) : void
      {
         ...
         if(form.contains(_loc2_))
         {
            ...
            {
               var _loc3_:Button = Button(lastFocus);
               if(defButton)
               {
                  defButton.emphasized = false;
                  defButton = null;
