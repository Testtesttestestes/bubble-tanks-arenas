package fl.motion
{
   ...
   public class AnimatorBase extends EventDispatcher
   {
      ...
      {
         var _loc6_:AnimatorParent = _registeredParents[param1] as AnimatorParent;
         if(_loc6_ == null)
         {
         ...
         for(_loc2_ in _registeredParents)
         {
            ...
            if(_loc3_)
            {
               ...
               if(!(!_loc4_ || !_loc5_))
               {
                  ...
                  {
                     _loc7_ = _loc5_[_loc6_] as AnimatorBase;
      ...
      public function set time(param1:int) : void
      {
         ...
         if(!_loc3_.blank)
         {
            ...
            var _loc6_:Array = _loc2_.getFilters(param1);
            if(_loc6_)
            {
...
class AnimatorParent
{
   ...
   public function AnimatorParent()
   {
      super();
   }
}
