package Parts
{
   ...
   public class EGunEnemyBigCannon extends Weapon
   {
      
      public var var_18:MovieClip;
      
      public function EGunEnemyBigCannon()
      {
         super();
         intFireRate = 90;
      }
      ...
      override public function PartCallTrigger() : void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new class_131(),_loc1_.x,_loc1_.y,2.5,this.rotation + var_3.rotation,5,4);
      }
   }
}
