...
const FLASH_STUB_HEADER = [
  ...
  'declare class ByteArray { [key: string]: any; }',
  'declare class Endian { [key: string]: any; }',
  'declare class Matrix { [key: string]: any; }',
  'declare class Point { [key: string]: any; }',
  'declare class Rectangle { [key: string]: any; }',
  'declare class DisplayObject { [key: string]: any; }',
  'declare class DisplayObjectContainer { [key: string]: any; }',
  'declare class InteractiveObject { [key: string]: any; }',
  'declare class MovieClip { [key: string]: any; }',
  'declare class Sprite { [key: string]: any; }',
  'declare class Shape { [key: string]: any; }',
  'declare class Bitmap { [key: string]: any; }',
  'declare class BitmapData { [key: string]: any; }',
  'declare class Loader { [key: string]: any; }',
  'declare class URLRequest { [key: string]: any; }',
  'declare class Event { [key: string]: any; }',
  'declare class MouseEvent { [key: string]: any; }',
  'declare class KeyboardEvent { [key: string]: any; }',
  'declare class FocusEvent { [key: string]: any; }',
  'declare class TimerEvent { [key: string]: any; }',
  'declare class TextField { [key: string]: any; }',
  'declare class TextFormat { [key: string]: any; }',
  'declare class Graphics { [key: string]: any; }',
  'declare class Sound { [key: string]: any; }',
  'declare class SoundChannel { [key: string]: any; }',
  'declare class SoundTransform { [key: string]: any; }',
  'declare class Stage { [key: string]: any; }',
  'declare class ApplicationDomain { [key: string]: any; }',
  'declare class ContextMenu { [key: string]: any; }',
  'declare class ContextMenuItem { [key: string]: any; }',
  'declare class Dictionary { [key: string]: any; }',
  'declare class DebugUtil { [key: string]: any; }',
  'declare class AGUIState { [key: string]: any; }',
  'declare class ClientError { [key: string]: any; }',
  'declare class AGITimeFrame { [key: string]: any; }',
  'declare class ISymmetricKey { [key: string]: any; }',
  'declare class Client { [key: string]: any; }',
