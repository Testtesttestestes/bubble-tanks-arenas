...
import { class_30 } from '../package_2/class_30';
...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public init(param1: ByteArray): void
      {
         ...
         while(_loc2_ < 256)
         {
            _loc3_ = _loc3_ + this.S[_loc2_ as any] + param1[_loc2_ % param1.length as any] & 0xFF;
            _loc4_ = int(this.S[_loc2_ as any]);
            this.S[_loc2_ as any] = this.S[_loc3_ as any];
            this.S[_loc3_ as any] = _loc4_;
            _loc2_++;
         }
         this.i = 0;
         this.j = 0;
      ...
      public method_601(): number
      {
         ...
         this.j = this.j + this.S[this.i as any] & 0xFF;
         _loc1_ = int(this.S[this.i as any]);
         this.S[this.i as any] = this.S[this.j as any];
         this.S[this.j as any] = _loc1_;
         return this.S[_loc1_ + this.S[this.i as any] & 0xFF];
      }
      ...
      public encrypt(param1: ByteArray): void
      {
         ...
         {
            var _temp_2: any = param1;
            var _loc3_: number = _loc2_++;
            _temp_2[_loc3_ as any] ^= this.method_601();
         }
      }
      ...
      public dispose(): void
      {
         ...
         if(this.S != null)
         {
            ...
            {
               this.S[_loc1_ as any] = Math.random() * 256;
               _loc1_++;
            }
            this.S.length = 0;
            this.S = null as any;
