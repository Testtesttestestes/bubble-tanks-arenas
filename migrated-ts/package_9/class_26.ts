...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: any = null){
         ...
         this.state = new (param1 as any)()  as unknown as class_24;
         this.name_2 = this.state.method_752();
         this.var_105 = new (ByteArray as any)();
         this.var_87 = 0;
         while(this.var_87 < this.name_2)
         {
            _loc2_ = 65536 * Math.random();
            this.var_105[this.var_87++ as any] = _loc2_ >>> 8;
            var _loc4_: number;
            this.var_105[_loc4_ = this.var_87++ as any] = _loc2_ & 0xFF;
         }
         this.var_87 = 0;
         this.method_457();
      }
      ...
      public method_610(): void
      {
         ...
         _loc1_.writeUnsignedInt(Date.now());
         _loc1_.writeUnsignedInt(new (Date as any)().getTime());
      ...
      public method_457(param1: number = 0): void
      {
         if(param1 == 0)
         {
            param1 = new (Date as any)().getTime();
         }
         var _temp_3: any = this.var_105;
         var _loc2_: number = this.var_87++;
         _temp_3[_loc2_ as any] ^= param1 & 0xFF;
         var _temp_6: any = this.var_105;
         var _loc3_: number = this.var_87++;
         _temp_6[_loc3_ as any] ^= param1 >> 8 & 0xFF;
         var _loc4_: number;
         this.var_105[_loc4_ = this.var_87++ as any] = this.var_105[_loc4_ as any] ^ param1 >> 16 & 0xFF;
         var _loc5_: number;
         this.var_105[_loc5_ = this.var_87++ as any] = this.var_105[_loc5_ as any] ^ param1 >> 24 & 0xFF;
      ...
      public dispose(): void
      {
         ...
         {
            this.var_105[_loc1_ as any] = Math.random() * 256;
            _loc1_++;
         }
         this.var_105.length = 0;
         this.var_105 = null as any;
         this.state.dispose();
