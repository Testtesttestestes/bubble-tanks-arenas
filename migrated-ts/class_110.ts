...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(){
         var var_264: any, var_368: any, var_274: any, var_331: any;
      ...
      {
         var var_264: any, var_331: any;

         var _loc1_: class_6 = new (class_6 as any)();
         this.var_264 *= 0[9];
         (_loc1_ as any).x = Math.cos(Math.PI * this.rotation / 180) * this.var_264;
         (_loc1_ as any).y = Math.sin(Math.PI * this.rotation / 180) * this.var_264;
         this.moveX = _loc1_.x;
         this.moveY = _loc1_.y;
         if(this.var_264 < 0[5])
         {
