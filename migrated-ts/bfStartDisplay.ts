...
// @ts-ignore
export class bfStartDisplay extends MovieClip{
  [key: string]: any;
      ...
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(0,this.frame1,1,this.frame2,2,this.frame3,3,this.frame4,4,this.frame5,5,this.frame6,34,this.frame35);
      }
