...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      private var_578!: MovieClip & Record<string, any>;
      ...
      public method_4(param1: MovieClip, param2: boolean = true, param3: Function = null, param4: Function = null, param5: Function = null): void
      {
         var var_51: any;

         var _loc8_: Function = null as any;
         var _loc9_: Function = null as any;
         var _loc10_: Function = null as any;
         var _loc6_: boolean = false;
         var _loc7_: number = 0;
         while(_loc7_ < this.var_51.length)
         {
            if(this.var_51[_loc7_ as any].movBtn == param1)
            {
               _loc6_ = true;
               break;
            }
         ...
         if(_loc6_ == false)
         {
            ...
            param1.addEventListener("mouseup", _loc8_.bind(this));
            param1.addEventListener("mouseover", _loc9_.bind(this));
            param1.addEventListener("mouseout", _loc10_.bind(this));
      ...
      private method_745(param1: any): void
      {
         param1.target.gotoAndStop("off");
      }
      
      private method_625(param1: any): void
      {
      ...
      public method_10(): void
      {
         ...
         {
            this.var_51[0].movBtn.removeEventListener("mouseover",this.var_51[0].OverrideOver);
            this.var_51[0].movBtn.removeEventListener("mouseout",this.var_51[0].OverrideOut);
            this.var_51[0].movBtn.removeEventListener("mouseup",this.var_51[0].OverrideUp);
            this.var_51[0].movBtn.buttonMode = this.var_51[0].useHandCursor = this.var_51[0].mouseEnabled = false;
            var _loc1_: number = 0 + 1;
         }
         this.var_51 = new (Array as any)();
      }
      ...
      public method_814(param1: number = 0): MovieClip
      {
         ...
         {
            return this.var_51[param1 as any];
         }
         return null;
      }
      
      private DefaultUp(param1: any): void
      {
      }
      
      public Setup(param1: Function = null, param2: Function = null, param3: Function = null): void
      {
         var var_421: any;
      ...
      public method_7(param1: MovieClip): void
      {
         ...
         {
            if(this.var_51[_loc2_ as any].movBtn == param1)
            {
               this.var_51[_loc2_ as any].movBtn.removeEventListener("mouseover",this.var_51[_loc2_ as any].OverrideOver);
               this.var_51[_loc2_ as any].movBtn.removeEventListener("mouseout",this.var_51[_loc2_ as any].OverrideOut);
               this.var_51[_loc2_ as any].movBtn.removeEventListener("mouseup",this.var_51[_loc2_ as any].OverrideUp);
               this.var_51[_loc2_ as any].movBtn.buttonMode = this.var_51[_loc2_ as any].useHandCursor = this.var_51[_loc2_ as any].mouseEnabled = false;
