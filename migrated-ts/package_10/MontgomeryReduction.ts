...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: class_25){
         ...
         var var_422: any, var_464: any, var_483: any, var_530: any;
      ...
      public method_63(param1: class_25): void
      {
         ...
         {
            var _loc5_: number;
            param1.a[_loc5_ = param1.t++ as any] = 0;
         }
         var _loc2_: number = 0;
         while(_loc2_ < this.m.t)
         {
            _loc3_ = param1.a[_loc2_ as any] & 0x7FFF;
            _loc4_ = _loc3_ * this.var_464 + ((_loc3_ * this.var_483 + (param1.a[_loc2_ as any] >> 15) * this.var_464 & this.var_530) << 15) & class_25.const_5;
            _loc3_ = _loc2_ + this.m.t;
            param1.a[_loc3_ as any] += this.m.method_75(0,_loc4_,param1,_loc2_,0,this.m.t);
            while(param1.a[_loc3_ as any] >= class_25.const_6)
            {
               param1.a[_loc3_ as any] -= class_25.const_6;
               ++param1.a[++_loc3_ as any];
            }
            _loc2_++;
         }
         param1.method_45();
