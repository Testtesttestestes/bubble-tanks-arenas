...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: class_79, param2: Stage){
         ...
         var var_425: any, var_162: any, var_278: any, var_376: any;


         this.intShakeDuration = 0;
         this.mainRef = param1;
         this.var_425 = param2;
         this.mainRef.addEventListener("enterframe", this.Run.bind(this));
         this.var_162 = new (Array as any)();
         this.intShakeDuration = 0;
         this.var_278 = 0;
         this.var_376 = 0;
         this.ShakeSetup();
      ...
      {
         var var_425: any, var_162: any;

         var sFlashMC: MovieClip = null as any;
         var fColor: number = param1;
         try
         {
            sFlashMC = new (MovieClip as any)();
            (sFlashMC as any).x = -40;
            (sFlashMC as any).y = -40;
            ...
            this.var_162.push(sFlashMC as any);
         }
         catch (e: any)
         {
         }
      ...
      {
         this.mainRef.removeEventListener("enterframe", this.Run.bind(this));
      }
      
      private method_437(param1: class_6): void
      {
         (param1 as any).x = Math.round(param1.x);
         (param1 as any).y = Math.round(param1.y);
      ...
      public method_259(): void
      {
         ...
         var _loc3_: class_6 = null as any;
         if(this.mainRef.x != this.var_138.x || this.mainRef.y != this.var_138.y)
         {
            ...
            (this.mainRef as any).x = this.var_138.x;
            (this.mainRef as any).y = this.var_138.y;
            _loc3_ = new (class_6 as any)();
            (_loc3_ as any).x = _loc1_;
      ...
      public SHAKE(param1: number): void
      {
         ...
         if(this.intShakeDuration == 0)
         {
            ...
            this.var_376 = param1;
            this.var_278 = 3;
            (this.var_138 as any).x = this.mainRef.x;
            (this.var_138 as any).y = this.mainRef.y;
         }
      }
      ...
      private method_651(): void
      {
         ...
         {
            if(this.var_162[_loc1_ as any].alpha <= 0)
            {
               this.method_696(this.var_162[_loc1_ as any]);
               this.var_162.splice(_loc1_,1);
               _loc1_--;
            }
            else
            {
               this.var_162[_loc1_ as any].alpha -= 0[05];
            }
            _loc1_++;
         }
      }
      ...
      public method_696(param1: MovieClip): void
      {
         ...
         var var_40: MovieClip = null as any;
         var var_56: number = 0;
         ...
         try
         {
            ...
            {
               if(this.var_162[var_56 as any] == var_40)
               {
      ...
      {
         var var_399: any, var_162: any, var_463: any, var_138: any;

         this.intShakeDuration = 0;
         this.var_399 = true;
         this.var_162 = new (Array as any)();
         this.var_463 = this.var_138 = new (class_6 as any)();
         (this.var_463 as any).x = (this.var_138 as any).x = this.mainRef.x;
         (this.var_463 as any).y = (this.var_138 as any).y = this.mainRef.y;
         this.method_259();
      }
      ...
      private method_757(): void
      {
         ...
         var _loc7_: class_6 = null as any;
         if(this.intShakeDuration > 0)
         {
            ...
            else
            {
               ...
               if(this.var_278 == 0)
               {
                  ...
                  (this.mainRef as any).x = _loc3_;
                  (this.mainRef as any).y = _loc4_;
                  _loc7_ = new (class_6 as any)();
                  (_loc7_ as any).x = _loc5_;
                  (_loc7_ as any).y = _loc6_;
