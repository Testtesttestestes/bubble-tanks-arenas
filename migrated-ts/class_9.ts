...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: Stage, param2: boolean, param3: boolean, param4: boolean, param5: boolean = true){
         ...
         var var_325: any, var_513: any, var_539: any, var_353: any, var_373: any, var_375: any, var_393: any, var_175: any, var_247: any;
         ...
         this.var_353 = new (Array as any)();
         this.var_373 = new (Array as any)();
         this.var_375 = new (Array as any)();
         this.var_393 = new (Array as any)();
         this.var_175 = false;
         this.var_247 = false;
      ...
      public AddECDomain(param1: string): void
      {
         ...
         this.var_375.push(param1 as any);
      }
      ...
      public AddAllowableDomain(param1: string): void
      {
         ...
         this.var_353.push(param1 as any);
      }
      
      private method_638(param1: any): void
      {
         var var_350: any, var_175: any, var_247: any;

         var _loc2_: XML = new (XML as any)(this.var_350.data);
      ...
      public AddBlockedDomain(param1: string): void
      {
         ...
         this.var_393.push(param1 as any);
      }
      ...
      public method_772(): boolean
      {
         ...
         {
            if(_loc1_.indexOf(this.var_373[_loc2_ as any]) != -1)
            {
               return false;
            }
            _loc2_++;
      ...
      public method_668(): boolean
      {
         ...
         {
            if(_loc1_.indexOf(this.var_375[_loc2_ as any]) != -1)
            {
               return true;
            }
            _loc2_++;
      ...
      public method_527(): boolean
      {
         ...
         {
            if(_loc1_.indexOf(this.var_393[_loc2_ as any]) != -1)
            {
               return true;
            }
            _loc2_++;
         ...
         {
            if(_loc1_.indexOf(this.var_353[_loc3_ as any]) != -1)
            {
               return false;
            }
            _loc3_++;
      ...
      private method_727(param1: any): void
      {
         var var_175: any, var_247: any;
      ...
      private SearchForXMLException(): void
      {
         ...
         var _loc1_: URLRequest = new (URLRequest as any)("AllowGameURLAccess.xml");
         this.var_350 = new (URLLoader as any)();
         this.var_350.addEventListener("complete", this.method_638.bind(this));
      ...
      public AddAdFreeDomain(param1: string): void
      {
         ...
         this.var_373.push(param1 as any);
      }
   }
