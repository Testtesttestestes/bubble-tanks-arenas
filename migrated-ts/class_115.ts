...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      {
         var _loc1_: any = this.addChild(new (class_82 as any)());
      }
      ...
      {
         var var_504: any, var_506: any, var_319: any, var_546: any, var_556: any;

         this.var_504 = 20;
         this.var_506 = 60;
         this.var_319 = 0;
         this.var_546 = new (Array as any)();
         this.var_556 = 0;
         param1.addEventListener("enterframe", this.method_665.bind(this));
      }
      
      public method_665(param1: any): void
      {
         var var_319: any, var_504: any, var_506: any;
