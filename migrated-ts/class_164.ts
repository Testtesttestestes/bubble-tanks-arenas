...
import { class_112 } from './class_112';
...
// @ts-ignore
export class class_164 extends class_112{
  [key: string]: any;
      
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(0,this.frame1,154,this.frame155,299,this.frame300);
      }
