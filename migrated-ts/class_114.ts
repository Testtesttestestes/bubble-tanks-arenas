...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      {
         (ExternalInterface.call as any)(const_19,param1,param2,param3);
      }
      
      public method_104(param1: string, param2: string = null): void
      {
         var var_106: string = param1;
         var var_40: string = param2;
         var var_56: URLRequest = new (URLRequest as any)(var_106);
         try
         {
