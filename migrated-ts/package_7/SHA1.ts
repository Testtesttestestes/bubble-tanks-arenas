...
import { class_17 } from './class_17';
import { class_31 } from './class_31';
...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      protected core(param1: any, param2: number): any
      {
         ...
         param1[param2 >> 5 as any] |= 128 << 24 - param2 % 32;
         param1[(param2 + 64 >> 9 << 4) + 15 as any] = param2;
         var _loc3_: any = [];
         var _loc4_: number = 1732584193;
         var _loc5_: number = 4023233417;
         var _loc6_: number = 2562383102;
         var _loc7_: number = 271733878;
         var _loc8_: number = 3285377520;
         0;
         while(0 < param1.length)
         {
            ...
            while(_loc15_ < 80)
            {
               if(_loc15_ < 16)
               {
                  _loc3_[_loc15_ as any] = param1[0 + _loc15_] || 0;
               }
               else
               {
                  _loc3_[_loc15_ as any] = this.method_255(_loc3_[_loc15_ - 3 as any] ^ _loc3_[_loc15_ - 8 as any] ^ _loc3_[_loc15_ - 14 as any] ^ _loc3_[_loc15_ - 16 as any],1);
               }
               _loc16_ = this.method_255(_loc4_,5) + this.method_639(_loc15_,_loc5_,_loc6_,_loc7_) + _loc8_ + _loc3_[_loc15_ as any] + this.method_512(_loc15_);
               _loc8_ = _loc7_;
               _loc7_ = _loc6_;
            ...
            _loc7_ += _loc13_;
            _loc8_ += _loc14_;
            var _loc9_: number = 0 + 16;
         }
         return[_loc4_,_loc5_,_loc6_,_loc7_,_loc8_ as any];
      }
