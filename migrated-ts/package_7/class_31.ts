...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public name_1(param1: ByteArray): ByteArray
      {
         ...
         {
            _loc5_.push(param1.readUnsignedInt() as any);
            _loc6_ += 4;
         }
         var _loc7_: any = this.core(_loc5_,_loc4_);
         var _loc8_: ByteArray = new (ByteArray as any)();
         var _loc9_: number = this.getHashSize() / 4;
         _loc6_ = 0;
         while(_loc6_ < _loc9_)
         {
            _loc8_.writeUnsignedInt(_loc7_[_loc6_ as any]);
            _loc6_++;
         }
