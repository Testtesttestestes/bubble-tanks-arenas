...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public static method_22(param1: string, param2: boolean = false): string
      {
         ...
         return class_13.method_52(_loc3_,param2);
      }
      
      public static toString(param1: string): string
      {
         var _loc2_: ByteArray = class_13.toArray(param1);
      ...
      public static toArray(param1: string): ByteArray
      {
         ...
         {
            _loc2_[_loc3_ / 2 as any] = parseInt(param1.substr(_loc3_,2),16);
            _loc3_ += 2;
         }
         return _loc2_;
      }
      ...
      public static method_52(param1: ByteArray, param2: boolean = false): string
      {
         ...
         {
            _loc3_ += ("0" + param1[_loc4_ as any].toString(16)).substr(-2,2);
            if(param2)
            {
