...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(){
         ...
         throw new (Error as any)("Base64 export class instanceofstatic container only");
      }
      ...
      public static method_827(param1: string): string
      {
         ...
         return Base64.method_330(_loc2_);
      }
      ...
      public static method_330(param1: ByteArray): string
      {
         ...
         var _loc7_: number = 0;
         var _loc2_: string = "";
         var _loc4_: any = new (Array as any)(4);
         param1.position = 0;
         while(param1.bytesAvailable > 0)
         {
            _loc3_ = new (Array as any)();
            _loc5_ = 0;
            while(_loc5_ < 3 && param1.bytesAvailable > 0)
            {
               _loc3_[_loc5_ as any] = param1.readUnsignedByte();
               _loc5_++;
            }
            ...
            while(_loc6_ < 3)
            {
               _loc4_[_loc6_ + 1 as any] = 64;
               _loc6_++;
            }
            _loc7_ = 0;
            while(_loc7_ < _loc4_.length)
            {
               _loc2_ += Base64.BASE64_CHARS.charAt(_loc4_[_loc7_ as any]);
               _loc7_++;
            }
         }
         return _loc2_;
      ...
      {
         var _loc2_: ByteArray = Base64.method_462(param1);
      ...
      public static method_462(param1: string): ByteArray
      {
         ...
         var _loc7_: number = 0;
         var _loc2_: ByteArray = new (ByteArray as any)();
         var _loc3_: any = new (Array as any)(4);
         var _loc4_: any = new (Array as any)(3);
         var _loc5_: number = 0;
         while(_loc5_ < param1.length)
         {
            ...
            {
               _loc3_[_loc6_ as any] = Base64.BASE64_CHARS.indexOf(param1.charAt(_loc5_ + _loc6_));
               _loc6_++;
            }
            ...
            while(_loc7_ < _loc4_.length)
            {
               if(_loc3_[_loc7_ + 1 as any] == 64)
               {
                  break;
               }
               _loc2_.writeByte(_loc4_[_loc7_ as any]);
               _loc7_++;
            }
            _loc5_ += 4;
         }
