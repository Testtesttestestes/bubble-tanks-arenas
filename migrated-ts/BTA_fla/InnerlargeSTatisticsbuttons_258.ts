...
// @ts-ignore
export class InnerlargeSTatisticsbuttons_258 extends MovieClip{
  [key: string]: any;
      
      public textBoxes_mc!: MovieClip & Record<string, any>;
      public Mask_mc!: MovieClip & Record<string, any>;
      constructor(){
         // @ts-ignore
         super();
