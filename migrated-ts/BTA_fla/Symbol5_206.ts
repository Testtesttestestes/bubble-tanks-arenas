...
// @ts-ignore
export class Symbol5_206 extends MovieClip{
  [key: string]: any;
      
      public btnYes!: MovieClip & Record<string, any>;
      public btnNo!: MovieClip & Record<string, any>;
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(0,this.frame1,11,this.frame12);
      }
