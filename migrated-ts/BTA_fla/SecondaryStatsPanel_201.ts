...
// @ts-ignore
export class SecondaryStatsPanel_201 extends MovieClip{
  [key: string]: any;
      
      public SpeedCurrent_txt!: TextField;
      public suggestedBox_mc!: MovieClip & Record<string, any>;
      public SpeedSlider_mc!: MovieClip & Record<string, any>;
      public LifeCurrent_txt!: TextField;
      public BubblesReturnedCurrent_txt!: TextField;
      public SpeedMax_txt!: TextField;
      public ConfirmMenu_mc!: MovieClip & Record<string, any>;
      public LifeSlider_mc!: MovieClip & Record<string, any>;
      public LifeMax_txt!: TextField;
      public BubblesReturnedSlider_mc!: MovieClip & Record<string, any>;
      public BubblesReturnedMax_txt!: TextField;
      constructor(){
         // @ts-ignore
         super();
