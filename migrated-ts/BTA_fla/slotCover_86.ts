...
// @ts-ignore
export class slotCover_86 extends MovieClip{
  [key: string]: any;
      
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(0,this.frame1,1,this.frame2,84,this.frame85,85,this.frame86,159,this.frame160,160,this.frame161);
      }
