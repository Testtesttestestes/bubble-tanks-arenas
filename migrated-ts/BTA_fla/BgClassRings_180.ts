...
// @ts-ignore
export class BgClassRings_180 extends MovieClip{
  [key: string]: any;
      
      public ring5_mc!: MovieClip & Record<string, any>;
      public ring3_mc!: MovieClip & Record<string, any>;
      public ring1_mc!: MovieClip & Record<string, any>;
      public class1_txt!: TextField;
      public class2_txt!: TextField;
      public class3_txt!: TextField;
      public class4_txt!: TextField;
      public class5_txt!: TextField;
      public class6_txt!: TextField;
      public ring4_mc!: MovieClip & Record<string, any>;
      public ring2_mc!: MovieClip & Record<string, any>;
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(0,this.frame1,1,this.frame2,2,this.frame3,3,this.frame4,4,this.frame5,5,this.frame6);
      }
