...
// @ts-ignore
export class tutorial_217 extends MovieClip{
  [key: string]: any;
      
      public next_tut!: MovieClip & Record<string, any>;
      public back_tut!: MovieClip & Record<string, any>;
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(0,this.frame1,1,this.frame2,2,this.frame3,3,this.frame4,4,this.frame5,5,this.frame6,6,this.frame7,7,this.frame8,8,this.frame9);
      }
