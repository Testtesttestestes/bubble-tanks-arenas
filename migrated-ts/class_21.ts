...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public y!: number;
      public z!: number;
      constructor(param1: number = 0, param2: number = 0, param3: number = 0, param4: number = 0, param5: number = 0, param6: number = 0, param7: number = 0, param8: number = 0, param9: number = 0, param10: number = 4278190080, param11: number = 1, param12: number = 1, param13: number = 500, param14: number = 500, param15: class_21 = null){

         var var_398: any, var_361: any, var_309: any, var_481: any, var_497: any, var_480: any, var_524: any, var_179: any, var_452: any;


         (this as any).x = param1;
         (this as any).y = param2;
         this.z = param3;
         this.var_398 = param4;
         this.var_361 = param5;
         this.var_309 = param6;
