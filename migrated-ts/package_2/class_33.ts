...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      private static readonly const_14: number = class_33.const_11 + 2;
      private S3!: any;
      private P!: any;
      private S1!: any;
      private var_73: ByteArray = null as any;
      private S0!: any;
      private S2!: any;
      constructor(param1: ByteArray){
         ...
         this.var_73 = param1;
         this.method_478(param1);
      }
      
      private F(param1: number): number
      {
         return(this.S0[param1 >>> 24] + this.S1[param1 >>> 16 & 0xFF] ^ this.S2[param1 >>> 8 & 0xFF]) + this.S3[param1 & 0xFF as any];
      }
      
      private BytesTo32bits(param1: ByteArray, param2: number): number
      {
         return(param1[param2] & 0xFF) << 24 | (param1[param2 + 1 as any] & 0xFF) << 16 | (param1[param2 + 2 as any] & 0xFF) << 8 | param1[param2 + 3 as any] & 0xFF;
      }
      
      private method_594(param1: ByteArray, param2: number, param3: ByteArray, param4: number): void
      {
         var _loc5_: number = this.BytesTo32bits(param1,param2);
         var _loc6_: number = this.BytesTo32bits(param1,param2 + 4);
         _loc5_ ^= this.P[class_33.const_11 + 1 as any];
         var _loc7_: number = class_33.const_11;
         while(_loc7_ > 0)
         {
            _loc6_ ^= this.F(_loc5_) ^ this.P[_loc7_ as any];
            _loc5_ ^= this.F(_loc6_) ^ this.P[_loc7_ - 1 as any];
            _loc7_ -= 2;
         }
         _loc6_ ^= this.P[0];
      ...
      {
         this.method_594(param1,param2,param1,param2);
      }
      
      public method_53(): number
      {
         return class_33.const_25;
      }
      ...
      private method_478(param1: ByteArray): void
      {
         var _loc5_: number = 0;
         var _loc6_: number = 0;
         this.S0 = class_33.KS0.concat();
         this.S1 = class_33.KS1.concat();
         this.S2 = class_33.KS2.concat();
         this.S3 = class_33.KS3.concat();
         this.P = class_33.const_26.concat();
         var _loc2_: number = param1.length;
         var _loc3_: number = 0;
         0;
         while(0 < class_33.const_14)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < 4)
            {
               _loc5_ = uint(_loc5_ << 8 | param1[_loc3_++ as any] & 0xFF);
               if(_loc3_ >= _loc2_)
               {
                  _loc3_ = 0;
               }
         ...
         this.method_146(this.P[class_33.const_14 - 2 as any],this.P[class_33.const_14 - 1 as any],this.S0);
         this.method_146(this.S0[class_33.const_12 - 2 as any],this.S0[class_33.const_12 - 1 as any],this.S1);
         this.method_146(this.S1[class_33.const_12 - 2 as any],this.S1[class_33.const_12 - 1 as any],this.S2);
         this.method_146(this.S2[class_33.const_12 - 2 as any],this.S2[class_33.const_12 - 1 as any],this.S3);
      }
      
      private method_146(param1: number, param2: number, param3: any): void
      {
         var _loc6_: number = 0;
         var _loc4_: number = param3.length;
         var _loc5_: number = 0;
         while(_loc5_ < _loc4_)
         {
            param1 ^= this.P[0];
            _loc6_ = 1;
            while(_loc6_ < class_33.const_11)
            {
               param2 ^= this.F(param1) ^ this.P[_loc6_ as any];
               param1 ^= this.F(param2) ^ this.P[_loc6_ + 1 as any];
               _loc6_ += 2;
            }
            param2 ^= this.P[class_33.const_11 + 1 as any];
            param3[_loc5_ as any] = param2;
            param3[_loc5_ + 1 as any] = param1;
            param2 = param1;
            param1 = uint(param3[_loc5_ as any]);
            _loc5_ += 2;
         }
      }
      ...
      {
         this.method_576(param1,param2,param1,param2);
      }
      ...
      public dispose(): void
      {
         ...
         {
            this.S0[_loc1_ as any] = 0;
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ < this.S1.length)
         {
            this.S1[_loc1_ as any] = 0;
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ < this.S2.length)
         {
            this.S2[_loc1_ as any] = 0;
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ < this.S3.length)
         {
            this.S3[_loc1_ as any] = 0;
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ < this.P.length)
         {
            this.P[_loc1_ as any] = 0;
            _loc1_++;
         }
         this.S0 = null as any;
         this.S1 = null as any;
      ...
      private method_576(param1: ByteArray, param2: number, param3: ByteArray, param4: number): void
      {
         var _loc5_: number = this.BytesTo32bits(param1,param2);
         var _loc6_: number = this.BytesTo32bits(param1,param2 + 4);
         _loc5_ ^= this.P[0];
         var _loc7_: number = 1;
         while(_loc7_ < class_33.const_11)
         {
            _loc6_ ^= this.F(_loc5_) ^ this.P[_loc7_ as any];
            _loc5_ ^= this.F(_loc6_) ^ this.P[_loc7_ + 1 as any];
            _loc7_ += 2;
         }
         _loc6_ ^= this.P[class_33.const_11 + 1 as any];
         this.Bits32ToBytes(_loc6_,param3,param4);
         this.Bits32ToBytes(_loc5_,param3,param4 + 4);
      }
      
      private Bits32ToBytes(param1: number, param2: ByteArray, param3: number): void
      {
         param2[param3 + 3 as any] = param1;
         param2[param3 + 2 as any] = param1 >> 8;
         param2[param3 + 1 as any] = param1 >> 16;
         param2[param3 as any] = param1 >> 24;
      }
