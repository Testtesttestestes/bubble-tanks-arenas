...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public pad(param1: ByteArray): void
      {
         ...
         var _loc2_: number = this.var_57 - param1.length % this.var_57;
         var _loc3_: number = 0;
         while(_loc3_ < _loc2_)
         {
            param1[param1.length as any] = _loc2_;
            _loc3_++;
         }
      }
      ...
      public unpad(param1: ByteArray): void
      {
         ...
         var _loc4_: number = 0;
         var _loc2_: number = param1.length % this.var_57;
         if(_loc2_ != 0)
         {
            throw new (Error as any)("PKCS#5::unpad: ByteArray.length isn\'t a multiple of the blockSize");
         }
         _loc2_ = uint(param1[param1.length - 1 as any]);
         var _loc3_: number = _loc2_;
         while(_loc3_ > 0)
         {
            _loc4_ = uint(param1[param1.length - 1 as any]);
            --param1.length;
            if(_loc2_ != _loc4_)
            {
               throw new (Error as any)("PKCS#5:unpad: Invalid padding value. expected [" + _loc2_ + "], found [" + _loc4_ + "]");
            }
            _loc3_--;
         }
      }
