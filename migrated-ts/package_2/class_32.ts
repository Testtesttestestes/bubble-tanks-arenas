...
export class class_32 implements class_18
   {
      ...
      private static var_17: ByteArray = new ByteArray();
      private static var_84: ByteArray = new ByteArray();
      private static Xtime2Sbox: ByteArray = new ByteArray();
      private static Xtime3Sbox: ByteArray = new ByteArray();
      private static Xtime2: ByteArray = new ByteArray();
      private static Xtime9: ByteArray = new ByteArray();
      private static var_89: ByteArray = new ByteArray();
      private static var_88: ByteArray = new ByteArray();
      private static var_85: ByteArray = new ByteArray();
  ...
  private state: ByteArray;
      ...
      constructor(param1: ByteArray){
         super();
         this.var_29 = new ByteArray();
         this.state = new ByteArray();
         this.var_412 = param1.length;
         this.var_73 = new ByteArray();
      ...
      {
         let _loc1_: number = 0;
         let _loc2_: class_26 = new class_26();
         _loc1_ = 0;
         while(_loc1_ < this.var_73.length)
         {
            this.var_73[_loc1_] = _loc2_.method_68();
            _loc1_++;
         }
         ...
         {
            this.state[_loc1_] = _loc2_.method_68();
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ < this.var_29.length)
         {
            this.var_29[_loc1_] = _loc2_.method_68();
            _loc1_++;
         }
      ...
      private method_645(): void
      {
         ...
         while(_loc6_ < this.const_10 * (this.var_221 + 1))
         {
            ...
            _loc3_ = Math.floor(this.var_73[4 * _loc6_ - 2]);
            _loc4_ = Math.floor(this.var_73[4 * _loc6_ - 1]);
            if(!(_loc6_ % _loc7_))
            {
               _loc5_ = _loc4_;
