  ...
  [key: string]: any;
      ...
      public decrypt(param1: ByteArray): void
      {
         ...
         while(_loc4_ < param1.length)
         {
            ...
            while(_loc5_ < var_57)
            {
               param1[_loc4_ + _loc5_ as any] ^= _loc2_[_loc5_ as any];
               _loc5_++;
            }
            _loc2_.position = 0;
