  ...
  [key: string]: any;
      ...
      public dispose(): void
      {
         ...
         if(this.encKey2 != null)
         {
            ...
            {
               this.encKey2[_loc1_ as any] = 0;
               _loc1_++;
            }
            this.encKey2 = null as any;
         }
         if(this.encKey3 != null)
         {
            ...
            {
               this.encKey3[_loc1_ as any] = 0;
               _loc1_++;
            }
            this.encKey3 = null as any;
         }
         if(this.decKey2 != null)
         {
            ...
            {
               this.decKey2[_loc1_ as any] = 0;
               _loc1_++;
            }
            this.decKey2 = null as any;
         }
         if(this.decKey3 != null)
         {
            ...
            {
               this.decKey3[_loc1_ as any] = 0;
               _loc1_++;
            }
            this.decKey3 = null as any;
         }
         class_27.method_59();
      }
