...
import { class_12 } from './class_12';
import { class_18 } from './class_18';
import { class_29 } from './class_29';
...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: class_18, param2: class_11 = null){
         ...
         if(param2 == null)
         {
            param2 = new (PKCS5 as any)(param1.method_53());
         }
         else
         {
      ...
      {
         var var_273: any, var_73: any;

         this.var_273.pad(param1);
         param1.position = 0;
         var _loc2_: number = this.var_73.method_53();
      ...
      public decrypt(param1: ByteArray): void
      {
         ...
         {
            throw new (Error as any)("ECB mode cipher length must be a multiple of blocksize " + _loc2_);
         }
         var _loc3_: ByteArray = new (ByteArray as any)();
         var _loc4_: ByteArray = new (ByteArray as any)();
         var _loc5_: number = 0;
