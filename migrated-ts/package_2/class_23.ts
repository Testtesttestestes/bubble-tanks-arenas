...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: class_18, param2: class_11 = null){

         var var_73: any, var_57: any;
         ...
         if(param2 == null)
         {
            param2 = new (PKCS5 as any)(this.var_57);
         }
         else
         {
         ...
         this.var_273 = param2;
         this.var_270 = new (class_26 as any)();
         this.var_141 = null as any;
         this.var_181 = new (ByteArray as any)();
      }
      ...
      protected getIV4d(): ByteArray
      {
         ...
         var _loc1_: ByteArray = new (ByteArray as any)();
         if(this.var_141)
         {
            _loc1_.writeBytes(this.var_141);
            return _loc1_;
         }
         throw new (Error as any)("an IV must be set before calling decrypt()");
      }
      ...
      public dispose(): void
      {
         ...
         if(this.var_141 != null)
         {
            ...
            {
               this.var_141[_loc1_ as any] = this.var_270.method_68();
               _loc1_++;
            }
         ...
         if(this.var_181 != null)
         {
            ...
            while(_loc1_ < this.var_141.length)
            {
               this.var_181[_loc1_ as any] = this.var_270.method_68();
               _loc1_++;
            }
            this.var_181.length = 0;
            this.var_181 = null as any;
         }
         this.var_73.dispose();
         this.var_73 = null as any;
         this.var_273 = null as any;
         this.var_270.dispose();
         this.var_270 = null as any;
         class_27.method_59();
      }
