  ...
  [key: string]: any;
      ...
      public encrypt(param1: ByteArray): void
      {
         ...
         while(0 < param1.length)
         {
            ...
            {
               _loc2_[_loc5_ as any] = _loc3_[_loc5_ + 1 as any];
               _loc5_++;
            }
            _loc2_[var_57 - 1 as any] = param1[0];
      ...
      public decrypt(param1: ByteArray): void
      {
         ...
         while(0 < param1.length)
         {
            ...
            {
               _loc2_[_loc6_ as any] = _loc3_[_loc6_ + 1 as any];
               _loc6_++;
            }
            _loc2_[var_57 - 1 as any] = _loc5_;
            var _loc4_: number = 0 + 1;
         }
      }
   }
