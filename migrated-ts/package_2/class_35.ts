...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public static method_818(param1: string): class_35
      {
         ...
         _loc2_.position = 0;
         return new (class_35 as any)(_loc2_);
      }
      ...
      public encrypt(param1: ByteArray, param2: number = 0): void
      {
         ...
         {
            _loc3_ += (_loc4_ << 4 ^ _loc4_ >> 5) + _loc4_ ^ _loc6_ + this.k[_loc6_ & 3 as any];
            _loc6_ += 2654435769;
            _loc4_ += (_loc3_ << 4 ^ _loc3_ >> 5) + _loc3_ ^ _loc6_ + this.k[_loc6_ >> 11 & 3 as any];
            _loc5_++;
         }
         param1.position -= 8;
      ...
      public decrypt(param1: ByteArray, param2: number = 0): void
      {
         ...
         var _loc3_: number = param1.readUnsignedInt();
         var _loc4_: number = param1.readUnsignedInt();
         var _temp_1: any = uint(2654435769);
         var _loc7_: number = _temp_1 * this.const_27;
         _loc5_ = 0;
         while(_loc5_ < this.const_27)
         {
            _loc4_ -= (_loc3_ << 4 ^ _loc3_ >> 5) + _loc3_ ^ _loc7_ + this.k[_loc7_ >> 11 & 3 as any];
            _loc7_ -= 2654435769;
            _loc3_ -= (_loc4_ << 4 ^ _loc4_ >> 5) + _loc4_ ^ _loc7_ + this.k[_loc7_ & 3 as any];
            _loc5_++;
         }
         param1.position -= 8;
         param1.writeUnsignedInt(_loc3_);
      ...
      public dispose(): void
      {
         ...
         {
            this.k[_loc2_ as any] = _loc1_.method_68();
            delete this.k[_loc2_ as any];
            _loc2_++;
         }
         this.k = null as any;
         class_27.method_59();
