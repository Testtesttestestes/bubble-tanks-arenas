...
// @ts-ignore
export class ArenaSlot extends MovieClip{
  [key: string]: any;
      ...
      public description_txt!: TextField;
      ...
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(0,this.frame1,1,this.frame2,39,this.frame40,41,this.frame42);
      }
