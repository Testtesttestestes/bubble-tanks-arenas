...
import { class_103 } from '../class_103';
...
// @ts-ignore
export class class_120 extends class_68{
  [key: string]: any;
      ...
      {
         objBFRef.AddEffectToQueue(new (class_103 as any)(),this.x,this.y,"TopEffectsLayer",true);
