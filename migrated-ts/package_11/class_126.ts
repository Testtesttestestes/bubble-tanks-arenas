      ...
      public TestForCollision(): boolean
      {
         ...
         while(_loc2_ < objBFRef.arrBullets.length)
         {
            if(objBFRef.arrBullets[_loc2_ as any].blnEnemy == false)
            {
               ...
               if(objBFRef.arrBullets[_loc2_ as any].hitTestPoint(_loc3_.x,_loc3_.y,true) == true || objBFRef.arrBullets[_loc2_ as any].hitTestPoint(_loc3_.x - moveX / 2,_loc3_.y - moveY / 2,true) == true || objBFRef.arrBullets[_loc2_ as any].hitTestPoint(_loc3_.x + moveX / 2,_loc3_.y + moveY / 2,true) == true)
               {
