...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      private method_754(param1: any): void
      {
      ...
      private method_647(param1: any): void
      {
         var _temp_3: any = this;
         var _temp_2: any = this;
         var _temp_1: any = false;
         _temp_2.useHandCursor = _temp_1;
      ...
      {
         this.mRef = param1;
         this.addEventListener("mouseup", this.method_732.bind(this));
         this.addEventListener("mouseover", this.method_754.bind(this));
         this.addEventListener("mouseout", this.method_647.bind(this));
      }
      ...
      private method_732(param1: any): void
      {
         var var_252: any;
