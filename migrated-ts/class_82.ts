...
export class class_82 extends MovieClip{
  [key: string]: any;
      ...
      public var_585!: MovieClip & Record<string, any>;
      public var_547!: number;
      constructor(){
         var var_547: any, var_370: any;
         ...
         (this as any).scaleX = _loc1_;
         (this as any).scaleY = this.scaleX;
         var _loc2_: number = Math.random() * 550;
         (this as any).x = _loc2_;
         (this as any).y = 470;
         this.addEventListener("enterframe", this.method_707.bind(this));
      }
      
      public method_707(param1: any): void
      {
         var var_370: any;
