...
import { HighscoreVO } from './HighscoreVO';
  ...
  [key: string]: any;
      ...
      public toObject(): any
      {
         ...
         if(Boolean(this.value))
         {
            ...
            _loc1_.rank = new (Object as any)();
            if(Boolean(this.value["rank"]))
            {
               if(Boolean(this.value["rank"]["daily"]))
               {
                  _loc1_.rank.daily = new (Object as any)();
               ...
               {
                  _loc1_.rank.weekly = new (Object as any)();
      ...
      public toScoreTypeObject(): any
      {
         ...
         if(Boolean(this.value))
         {
            ...
            {
               if(_loc1_.list.indexOf(this.value[_loc2_ as any]) == -1)
               {
                  _loc1_.list.push(this.value[_loc2_ as any] as any);
               }
               _loc2_++;
            }
         }
