...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public static addCall(param1: number, param2: Function, param3: any = null, param4: number = 1): void
      {
         if(!Caller.calls)
         {
            Caller.calls = new (Dictionary as any)();
         }
         var _loc5_: any = {
            "maxTime":param1,
            "elasped":0,
         ...
         (Caller.calls as any)[_loc5_ as any] = Caller.ids.toString();
         ++Caller.ids;
         Caller.start();
      }
      ...
      public static isCalling(param1: Function): boolean
      {
         ...
         for (let _loc3_ of (Object.values(Caller.calls as any) as any[]))
         {
      ...
      public static removeCall(param1: Function): void
      {
         ...
         for (let _loc3_ of (Object.values(Caller.calls as any) as any[]))
         {
            if(_loc3_.func == param1)
            {
               (Caller.calls as any)[_loc3_ as any] = null as any;
               delete(Caller.calls)[_loc3_ as any];
               _loc3_ = null as any;
            }
            _loc2_++;
         }
      ...
      public static removeAllCalls(): void
      {
         ...
         for (let _loc1_ of (Object.values(Caller.calls as any) as any[]))
         {
            (Caller.calls as any)[_loc1_ as any] = null as any;
            delete(Caller.calls)[_loc1_ as any];
            _loc1_ = null as any;
         }
         Caller.stop();
         Caller.paused = false;
      ...
      {
         if(Boolean(Caller.controller))
         {
            return;
         }
         Caller.controller = new (Sprite as any)();
         Caller.controller.addEventListener("enterframe", Caller.update.bind(this));
      }
      ...
      private static stop(): void
      {
         ...
         Caller.controller.removeEventListener("enterframe", Caller.update.bind(this));
         Caller.controller = null as any;
      }
      ...
      private static update(param1: any): void
      {
         ...
         ++Caller.frame;
         var _loc2_: number = uint(Date.now());
         var _loc3_: number = 0;
         for (let _loc4_ of (Object.values(Caller.calls as any) as any[]))
         {
            if(Boolean(_loc4_.useFrames))
            {
               _loc4_.elapsed = Caller.frame - _loc4_.last;
            }
            else
            {
            ...
            if(_loc4_.elapsed >= _loc4_.maxTime)
            {
               ...
               {
                  (Caller.calls as any)[_loc4_ as any] = null as any;
                  delete(Caller.calls)[_loc4_ as any];
                  _loc4_ = null as any;
               }
            }
            _loc3_++;
