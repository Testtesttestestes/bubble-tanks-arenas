...
export class LoginStatus extends Sprite{
  [key: string]: any;
      ...
      public update(param1: AGUser, param2: boolean = false): void
      {
         ...
         if(Boolean(param1))
         {
            _loc3_ = new (ColorTransform as any)();
            _loc3_.color = 9539985;
            this.logo_mc.transform.colorTransform = _loc3_;
            (this.logIn_mc as any).visible = false;
            (this.loggingIn_mc as any).visible = false;
            (this.loggedIn_mc as any).visible = true;
            this.loggedIn_mc.name_txt.htmlText = HTMLTextUtil.bold(param1.username);
            if(!this._loader)
            {
               this._loader = new (Loader as any)();
               ...
               this._loader.load(new (URLRequest as any)(param1.avatar_url));
            }
         }
         else
         {
            this.logo_mc.transform.colorTransform = new (ColorTransform as any)();
            (this.logIn_mc as any).visible = !param2;
            (this.loggingIn_mc as any).visible = param2;
            (this.loggedIn_mc as any).visible = false;
      ...
      private handleAvatarLoaded(param1: any): void
      {
         ...
         (this.loggedIn_mc.thumbnail_mc as any).scaleX = (this.loggedIn_mc.thumbnail_mc as any).scaleY = _loc2_;
