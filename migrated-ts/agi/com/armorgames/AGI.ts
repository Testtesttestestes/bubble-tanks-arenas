...
import { Crypto } from '../hurlant/crypto/Crypto';
import { ICipher } from '../hurlant/crypto/symmetric/ICipher';
import { AGUser } from './common/AGUser';
import { Caller } from './common/Caller';
import { HTMLTextUtil } from './common/HTMLTextUtil';
import { DebugUtil } from './debug/DebugUtil';
import { AGUIState } from './display/AGUIState';
import { LoginStatus } from './display/LoginStatus';
import { AGIShareMetric } from './enum/AGIShareMetric';
import { Client } from './services/Client';
import { ClientError } from './services/ClientError';
import { Base64 } from './services/compression/Base64';
import { Compressor } from './services/compression/Compressor';
import { JPGEncoder } from './services/images/JPGEncoder';
...
// @ts-ignore
  ...
  [key: string]: any;
    ...
    super();
         ...
         this.aguiParams = new (Object as any)();
         ...
         if(Boolean(stage))
         {
            ...
            _loc3_ = new (TextField as any)();
            (_loc3_ as any).width = stage.stageWidth;
...
public init(param1: string, param2: string, param3: Function = null, param4: boolean = false): void
      {
         ...
         this.callQueue = new (Array as any)();
         ...
         var _loc8_: any = _loc7_ ? _loc5_.split("?") : new (Array as any)();
         var _loc9_: any = _loc5_.split("/");
         var _loc10_: number = 0;
         while(_loc10_ < _loc9_.length - 1)
         {
            this.agui_url += _loc9_[_loc10_ as any] + "/";
            _loc10_++;
         }
...
public isComingFromShareURL(param1: Function): void
      {
         ...
         if(!this.displayRoot)
         {
            _loc3_ = "AGI Error: AGI requires access to the stage property in order retrieve game data. Please add the AGI  as unknown as a child to your document export class beforecalling isComingFromShareURL().";
            this.output(_loc3_);
            if(param1 != null)
            {
               param1({
...
public submitPublicDataObject(param1: any, param2: Function = null): void
      {
         var _loc4_: string = null as any;
         var _loc3_: any = new (Object as any)();
         for (let _loc4_ in param1)
         {
            _loc3_[_loc4_ as any] = this.convertDataToString(param1[_loc4_ as any]);
         }
...
public submitUserDataObject(param1: any, param2: Function = null): void
      {
         var _loc4_: string = null as any;
         if(!this.agUser)
         {
...
public initAGUI(param1: any = null): void
      {
...
public showLogin(param1: Function = null, param2: any = null): void
      {
         ...
         this.showProgress();
         var _loc3_: any = {"onLoginLogout":param1};
...
public showLoginStatus(param1: number = 0, param2: number = 0, param3: Function = null, param4: any = null): void
      {
         ...
         if(!this.loginStatus)
         {
            this.loginStatus = new (LoginStatus as any)();
         }
         (this.loginStatus as any).x = param1;
         (this.loginStatus as any).y = param2;
...
public showScoreboard(param1: any = null, param2: any = null, param3: any = null): void
      {
         this.removeAGUIFromScreen();
         if(Boolean(param3) && param3 instanceof DisplayObjectContainer)
         {
         ...
         var _loc4_: any = {"scoreTypes":null};
         if(Boolean(param1))
         {
...
public showGameShareList(param1: Function = null, param2: any = null): void
      {
         ...
         this.showProgress();
         var _loc3_: any = {"onShareClicked":param1};
...
public showGameShareNavi(param1: number = Infinity, param2: number = Infinity, param3: Function = null, param4: any = null): void
      {
         ...
         var _loc5_: any = {"onShareClicked":param3};
...
public __login(param1: string, param2: string, param3: Function): void
      {
         var _loc4_: ByteArray = new (ByteArray as any)();
...
public setDebugOutputCallback(param1: Function): void
      ...
      private iConnect(): void
      {
         ...
         this.client = new (Client as any)(this.clientDevKey,this.clientGameKey,this.displayRoot,this.onClientError);
      ...
      private iLogout(param1: Function = null): void
      {
         ...
         if(Boolean(this.aguiParams))
         {
            ...
            {
               DebugUtil.error("A callback failed.",e.message,e.stack);
            }
         }
         try
         {
      ...
      private iSubmitScore(param1: string, param2: number, param3: string = null, param4: Function = null, param5: boolean = true): void
      {
         ...
         {
            DebugUtil.error("Score value instanceof too high to submit. Please make sure the value instanceof lower than " + 2147483647 + ".");
            this.finishCall();
            this.callGlobalCallback({
               "success":false,
               "error":"Score value instanceof too high to submit. Please make sure the value instanceof lower than " + 2147483647 + "."
            });
            return;
         }
      ...
      private iSubmitGameShare(param1: string, param2: string, param3: Function = null, param4: any = null): void
      {
         ...
         if(Boolean(param4) && param4 instanceof DisplayObject)
         {
            ...
            _loc8_ = new (JPGEncoder as any)(80);
      ...
      private iSubmitGameSaveObject(param1: string, param2: any, param3: Function = null): void
      {
         if(!param1 || param1 == "")
         {
            return;
      ...
      private authenticationSuccess(param1: any): void
      {
      ...
      {
         var obj: any;
         var clientErr: ClientError = param1;
         ...
         this.clearBackground();
         this.clearQueue();
         this.showErrorMessage("Sorry but the Armor Games Services are temporarily unavailable. Please try again soon[Error 1 as any]");
         try
         {
      ...
      {
         var conCall: any = null as any;
         var obj: any = null as any;
         var clientErr: ClientError = param1;
         if(clientErr.getCode() == ClientError.CLIENT_TIMEOUT_ERROR)
         {
            if(this.connectionAttempts >= 3)
            {
               DebugUtil.error("AGI Services has failed to connect after " + this.connectionAttempts + " attempts.");
               this.handleConnectionFailed(clientErr);
               return;
            }
            ...
            {
               this.callQueue.unshift(conCall as any);
            }
            this.callNext();
            return;
         }
         if(!this.connected)
         {
            this.authenticationFailed(clientErr);
            return;
         }
      ...
      private onScoreTypesResult(param1: any): void
      {
         ...
         this.scoreTypes = new (Array as any)();
         if(Boolean(param1.isOk) && param1.toScoreTypeObject != null)
         {
            ...
            {
               _loc3_ = new (Object as any)();
               if(_loc2_.list[_loc4_ as any] == this.DEFAULT_SCORE_TYPE || _loc2_.list[_loc4_ as any] == "")
               {
                  _loc3_.type = null as any;
               }
               else
               {
                  _loc3_.type = _loc2_.list[_loc4_ as any];
               }
               this.scoreTypes.push(_loc3_ as any);
               _loc4_++;
            }
         }
         else
         {
            this.scoreTypes.push(new (Object as any)() as any);
         }
         this.finishCall();
      }
      ...
      private onRetrieveGameSaveObject(param1: any): void
      {
         ...
         if(Boolean(param1.isOk))
         {
            if(param1.toObject != null)
            {
               ...
               _loc3_.data = new (Object as any)();
               for (let _loc4_ in _loc2_.data)
               {
                  _loc3_.data[_loc4_ as any] = this.convertStringToData(_loc2_.data[_loc4_ as any]);
               }
               _loc2_ = _loc3_;
            }
            else
      ...
      private addCallToQueue(param1: Function, param2: any = null): void
      {
         ...
         this.callQueue.push(_loc3_ as any);
         if(!this.connected && !this.connecting)
         {
            ...
            this.callQueue.unshift(_loc4_ as any);
            this.connecting = true;
            this.callNext();
            return;
         }
      ...
      private callGlobalCallback(param1: any): void
      {
         var obj: any = param1;
         try
         {
      ...
      private loadAGUI(param1: string, param2: any = null): void
      {
         ...
         {
            this.aguiStateParams = new (Object as any)();
         }
         if(!this.aguiParams)
         {
            this.aguiParams = new (Object as any)();
         ...
         if(!this.agui)
         {
            if(!this.aguiLoader)
            {
               ...
               this.aguiLoader = new (Loader as any)();
               ...
               this.aguiLoader.load(new (URLRequest as any)(this.agui_url),new (LoaderContext as any)(true));
            }
            else
            {
      ...
      private showErrorMessage(param1: string): void
      {
         ...
         this.error = new (ErrorMessage as any)();
         ...
         {
            (this.error as any).x = this.aguiParams.x + 175;
            (this.error as any).y = this.aguiParams.y + 100;
         }
         else if(Boolean(stage))
         {
            (this.error as any).x = stage.stageWidth * 0[5];
            (this.error as any).y = stage.stageHeight * 0[5];
         }
         else
         {
            (this.error as any).x = 0;
            (this.error as any).y = 0;
         }
      }
      ...
      private showProgress(): void
      {
         ...
         this.progress = new (ProgressBar as any)();
         this.progress.close_btn.addEventListener("click", this.handleProgressClose.bind(this));
         super.addChild(this.progress);
         if(Boolean(this.aguiParams) && Boolean(this.aguiParams.x) && Boolean(this.aguiParams.y))
         {
            (this.progress as any).x = this.aguiParams.x + 100;
            (this.progress as any).y = this.aguiParams.y + 75;
         }
         else if(Boolean(stage))
         {
            (this.progress as any).x = stage.stageWidth * 0[5];
            (this.progress as any).y = stage.stageHeight * 0[5];
         }
         else
         {
            (this.progress as any).x = 0;
            (this.progress as any).y = 0;
         }
      ...
      private darkenBackground(): void
      {
         ...
         this.clearBackground();
         this.darkBG = new (DarkBG as any)();
         (this.darkBG as any).alpha = 0[5];
         (this.darkBG as any).x = 0;
         (this.darkBG as any).y = 0;
         (this.darkBG as any).width = 1000;
         (this.darkBG as any).height = 1000;
      ...
      private getBitmapFromDisplayObject(param1: DisplayObject, param2: number = 1000): Bitmap
      {
         ...
         if(param1.width > param1.height)
         {
            ...
            _loc5_ = new (BitmapData as any)(_loc3_,param1.height,false,4294967295);
         }
         else
         {
            ...
            _loc5_ = new (BitmapData as any)(param1.width,_loc3_,false,4294967295);
         }
         _loc5_.draw(param1,new (Matrix as any)(_loc4_,0,0,_loc4_),param1.transform.colorTransform,param1.blendMode);
         return new (Bitmap as any)(_loc5_);
      }
      ...
      private showAGUI(): void
      {
         ...
         {
            (aguiPos as any).x = Number(this.aguiParams.x);
         }
         else if(Boolean(stage))
         {
            (aguiPos as any).x = stage.stageWidth * 0[5] - 250 * scale;
         }
         if(this.aguiParams.hasOwnProperty("y"))
         {
            (aguiPos as any).y = this.aguiParams.y;
         }
         else if(Boolean(stage))
         {
            (aguiPos as any).y = stage.stageHeight * 0[5] - 175 * scale;
         }
         data = new (Object as any)();
         (data as any).x = aguiPos.x;
         (data as any).y = aguiPos.y;
         data.scale = scale;
      ...
      protected handleAGUILoginLogout(param1: any): void
      {
         var data: any = param1;
      ...
      protected handleAGUIShareClicked(param1: any): void
      {
         var data: any = param1;
         if(Boolean(this.aguiStateParams))
         {
      ...
      private handleAGUILoadFailed(param1: any): void
      {
         ...
         this.removeProgress();
         this.finishCall();
         this.showErrorMessage("Sorry but the Armor Games Services are temporarily unavailable. Please try again soon[Error 2 as any]");
         if(Boolean(this.aguiParams))
         {
            try
            {
