...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      private static _filters: any = new (Array as any)();
      constructor(){
      ...
      {
         DebugUtil.ON = param2;
         DebugUtil.EXTERN = param3;
         DebugUtil._apiName = param1;
         if(!param4)
         {
         ...
         {
            DebugUtil._filters = param4;
         }
      }
      
      public static forceOut(...rest: any[]): void
      {
         DebugUtil.output("OUT",rest,true);
      }
      
      public static out(...rest: any[]): void
      {
         DebugUtil.output("OUT",rest);
      }
      
      public static error(...rest: any[]): void
      {
         DebugUtil.output("ERROR",rest);
      }
      
      public static warn(...rest: any[]): void
      {
         DebugUtil.output("WARNING",rest);
      }
      
      public static info(...rest: any[]): void
      {
         DebugUtil.output("INFO",rest);
      }
      
      public static fatal(...rest: any[]): void
      {
         DebugUtil.output("FATAL",rest);
      }
      
      public static debug(...rest: any[]): void
      {
         DebugUtil.output("DEBUG",rest);
      }
      
      public static custom(param1: string, ...rest: any[]): void
      {
         DebugUtil.output(param1,rest);
      }
      ...
      public static getDebugInfo(param1: number = 3): string
      {
         ...
         var _loc2_: string = "";
         var _loc3_: Error = new (Error as any)();
         var _loc4_: string = _loc3_.stack;
         if(_loc4_.indexOf("[") == -1)
         {
            return "";
         }
         var _loc5_: any = _loc4_.split("\n");
         var _loc6_: any = _loc5_[param1 as any].split("[");
         var _loc7_: string = "";
         if(_loc6_[1] != null)
         {
            _loc9_ = _loc6_[1].split(":");
            _loc7_ = _loc9_[_loc9_.length - 1 as any].substr(0,_loc9_.length);
            if(_loc7_.indexOf("]") != -1)
            {
      ...
      {
         DebugUtil._debugOutputCallback = param1;
      }
      ...
      private static output(param1: string, param2: any, param3: boolean = false): void
      {
         if(!param3)
         {
            if(DebugUtil._apiName == "" || !DebugUtil.ON || DebugUtil._filters.indexOf(param1) == -1)
            {
               return;
            }
         }
         ...
         var _loc4_: string = "[ " + DebugUtil._apiName + " ] -> " + param1 + ": ";
         var _loc5_: number = 0;
         while(_loc5_ < param2.length)
         {
            if(param2[_loc5_ as any] == null)
            {
               _loc4_ += "null ";
            }
            else
            {
               _loc4_ += param2[_loc5_ as any].toString() + " ";
            }
            _loc5_++;
         }
         console.log(_loc4_);
         ...
         try
         {
            ...
            {
               (ExternalInterface.call as any)("console.log",_loc4_);
            }
         }
         catch (e: any)
         {
