...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(key: ISymmetricKey, padding: IPad = null){
         ...
         if(padding == null)
         {
            padding = new (PKCS5 as any)(this.blockSize);
         }
         else
         {
         ...
         this.prng = new (Random as any)();
         this.iv = null as any;
         this.lastIV = new (ByteArray as any)();
      }
      ...
      public dispose(): void
      {
         ...
         if(iv != null)
         {
            ...
            {
               iv[i as any] = this.prng.nextByte();
            }
            iv.length = 0;
            iv = null as any;
         }
         if(lastIV != null)
         {
            ...
            {
               lastIV[i as any] = this.prng.nextByte();
            }
            lastIV.length = 0;
            lastIV = null as any;
         }
