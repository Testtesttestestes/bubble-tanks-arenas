...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      private static readonly Nb: number = 4;
      private static readonly _Sbox: any = [99,124,119,123,242,107,111,197,48,1,103,43,254,215,171,118,202,130,201,125,250,89,71,240,173,212,162,175,156,164,114,192,183,253,147,38,54,63,247,204,52,165,229,241,113,216,49,21,4,199,35,195,24,150,5,154,7,18,128,226,235,39,178,117,9,131,44,26,27,110,90,160,82,59,214,179,41,227,47,132,83,209,0,237,32,252,177,91,106,203,190,57,74,76,88,207,208,239,170,251,67,77,51,133,69,249,2,127,80,60,159,168,81,163,64,143,146,157,56,245,188,182,218,33,16,255,243,210,205,12,19,236,95,151,68,23,196,167,126,61,100,93,25,115,96,129,79,220,34,42,144,136,70,238,184,20,222,94,11,219,224,50,58,10,73,6,36,92,194,211,172,98,145,149,228,121,231,200,55,109,141,213,78,169,108,86,244,234,101,122,174,8,186,120,37,46,28,166,180,198,232,221,116,31,75,189,139,138,112,62,181,102,72,3,246,14,97,53,87,185,134,193,29,158,225,248,152,17,105,217,142,148,155,30,135,233,206,85,40,223,140,161,137,13,191,230,66,104,65,153,45,15,176,84,187,22];
      private static readonly _InvSbox: any = [82,9,106,213,48,54,165,56,191,64,163,158,129,243,215,251,124,227,57,130,155,47,255,135,52,142,67,68,196,222,233,203,84,123,148,50,166,194,35,61,238,76,149,11,66,250,195,78,8,46,161,102,40,217,36,178,118,91,162,73,109,139,209,37,114,248,246,100,134,104,152,22,212,164,92,204,93,101,182,146,108,112,72,80,253,237,185,218,94,21,70,87,167,141,157,132,144,216,171,0,140,188,211,10,247,228,88,5,184,179,69,6,208,44,30,143,202,63,15,2,193,175,189,3,1,19,138,107,58,145,17,65,79,103,220,234,151,242,207,206,240,180,230,115,150,172,116,34,231,173,53,133,226,249,55,232,28,117,223,110,71,241,26,113,29,41,197,137,111,183,98,14,170,24,190,27,252,86,62,75,198,210,121,32,154,219,192,254,120,205,90,244,31,221,168,51,136,7,199,49,177,18,16,89,39,128,236,95,96,81,127,169,25,181,74,13,45,229,122,159,147,201,156,239,160,224,59,77,174,42,245,176,200,235,187,60,131,83,153,97,23,43,4,126,186,119,214,38,225,105,20,99,85,33,12,125];
      ...
      private static XtimeB: ByteArray = new (ByteArray as any)();
      private static XtimeD: ByteArray = new (ByteArray as any)();
      private static XtimeE: ByteArray = new (ByteArray as any)();
      private static i: number = 0;
  static {
    while(AESKey.i < 256) {
         AESKey.Sbox[i as any] = AESKey._Sbox[i as any];
         AESKey.InvSbox[i as any] = AESKey._InvSbox[i as any];
         AESKey.Xtime2Sbox[i as any] = AESKey._Xtime2Sbox[i as any];
         AESKey.Xtime3Sbox[i as any] = AESKey._Xtime3Sbox[i as any];
         AESKey.Xtime2[i as any] = AESKey._Xtime2[i as any];
         AESKey.Xtime9[i as any] = AESKey._Xtime9[i as any];
         AESKey.XtimeB[i as any] = AESKey._XtimeB[i as any];
         AESKey.XtimeD[i as any] = AESKey._XtimeD[i as any];
         AESKey.XtimeE[i as any] = AESKey._XtimeE[i as any];
         ++i;
      }
  }
  ...
  static {
    AESKey.i = 0;
    while(AESKey.i < AESKey._Rcon.length) {
         AESKey.Rcon[i as any] = AESKey._Rcon[i as any];
         ++i;
      }
  }
  private state!: ByteArray;
      ...
      constructor(key: ByteArray){
         ...
         this.tmp = new (ByteArray as any)();
         this.state = new (ByteArray as any)();
         this.keyLength = key.length;
         this.key = new (ByteArray as any)();
      ...
      public decrypt(block: ByteArray, index: number = 0): void
      {
         ...
         this.addRoundKey(key,this.Nr * AESKey.Nb * 4);
         this.invShiftRows();
         for(round = this.Nr; Boolean(round--); )
         {
            this.addRoundKey(key,round * AESKey.Nb * 4);
            if(Boolean(round))
            {
      ...
      {
         var tmp: number = 0;
         this.state[0] = AESKey.InvSbox[this.state[0 as any]];
         this.state[4] = AESKey.InvSbox[this.state[4 as any]];
         this.state[8] = AESKey.InvSbox[this.state[8 as any]];
         this.state[12] = AESKey.InvSbox[this.state[12 as any]];
         tmp = uint(AESKey.InvSbox[this.state[13 as any]]);
         this.state[13] = AESKey.InvSbox[this.state[9 as any]];
         this.state[9] = AESKey.InvSbox[this.state[5 as any]];
         this.state[5] = AESKey.InvSbox[this.state[1 as any]];
         this.state[1] = tmp;
         tmp = uint(AESKey.InvSbox[this.state[2 as any]]);
         this.state[2] = AESKey.InvSbox[this.state[10 as any]];
         this.state[10] = tmp;
         tmp = uint(AESKey.InvSbox[this.state[6 as any]]);
         this.state[6] = AESKey.InvSbox[this.state[14 as any]];
         this.state[14] = tmp;
         tmp = uint(AESKey.InvSbox[this.state[3 as any]]);
         this.state[3] = AESKey.InvSbox[this.state[7 as any]];
         this.state[7] = AESKey.InvSbox[this.state[11 as any]];
         this.state[11] = AESKey.InvSbox[this.state[15 as any]];
         this.state[15] = tmp;
      }
      ...
      public dispose(): void
      {
         ...
         {
            this.key[i as any] = r.nextByte();
         }
         this.Nr = r.nextByte();
         for(i = 0; i < this.state.length; i++)
         {
            this.state[i as any] = r.nextByte();
         }
         for(i = 0; i < this.tmp.length; i++)
         {
            this.tmp[i as any] = r.nextByte();
         }
         this.key.length = 0;
         this.keyLength = 0;
         this.state.length = 0;
      ...
      protected invMixSubColumns(): void
      {
         var i: number = 0;
         this.tmp.length = 0;
         this.tmp[0] = AESKey.XtimeE[this.state[0 as any]] ^ AESKey.XtimeB[this.state[1 as any]] ^ AESKey.XtimeD[this.state[2 as any]] ^ AESKey.Xtime9[this.state[3 as any]];
         this.tmp[5] = AESKey.Xtime9[this.state[0 as any]] ^ AESKey.XtimeE[this.state[1 as any]] ^ AESKey.XtimeB[this.state[2 as any]] ^ AESKey.XtimeD[this.state[3 as any]];
         this.tmp[10] = AESKey.XtimeD[this.state[0 as any]] ^ AESKey.Xtime9[this.state[1 as any]] ^ AESKey.XtimeE[this.state[2 as any]] ^ AESKey.XtimeB[this.state[3 as any]];
         this.tmp[15] = AESKey.XtimeB[this.state[0 as any]] ^ AESKey.XtimeD[this.state[1 as any]] ^ AESKey.Xtime9[this.state[2 as any]] ^ AESKey.XtimeE[this.state[3 as any]];
         this.tmp[4] = AESKey.XtimeE[this.state[4 as any]] ^ AESKey.XtimeB[this.state[5 as any]] ^ AESKey.XtimeD[this.state[6 as any]] ^ AESKey.Xtime9[this.state[7 as any]];
         this.tmp[9] = AESKey.Xtime9[this.state[4 as any]] ^ AESKey.XtimeE[this.state[5 as any]] ^ AESKey.XtimeB[this.state[6 as any]] ^ AESKey.XtimeD[this.state[7 as any]];
         this.tmp[14] = AESKey.XtimeD[this.state[4 as any]] ^ AESKey.Xtime9[this.state[5 as any]] ^ AESKey.XtimeE[this.state[6 as any]] ^ AESKey.XtimeB[this.state[7 as any]];
         this.tmp[3] = AESKey.XtimeB[this.state[4 as any]] ^ AESKey.XtimeD[this.state[5 as any]] ^ AESKey.Xtime9[this.state[6 as any]] ^ AESKey.XtimeE[this.state[7 as any]];
         this.tmp[8] = AESKey.XtimeE[this.state[8 as any]] ^ AESKey.XtimeB[this.state[9 as any]] ^ AESKey.XtimeD[this.state[10 as any]] ^ AESKey.Xtime9[this.state[11 as any]];
         this.tmp[13] = AESKey.Xtime9[this.state[8 as any]] ^ AESKey.XtimeE[this.state[9 as any]] ^ AESKey.XtimeB[this.state[10 as any]] ^ AESKey.XtimeD[this.state[11 as any]];
         this.tmp[2] = AESKey.XtimeD[this.state[8 as any]] ^ AESKey.Xtime9[this.state[9 as any]] ^ AESKey.XtimeE[this.state[10 as any]] ^ AESKey.XtimeB[this.state[11 as any]];
         this.tmp[7] = AESKey.XtimeB[this.state[8 as any]] ^ AESKey.XtimeD[this.state[9 as any]] ^ AESKey.Xtime9[this.state[10 as any]] ^ AESKey.XtimeE[this.state[11 as any]];
         this.tmp[12] = AESKey.XtimeE[this.state[12 as any]] ^ AESKey.XtimeB[this.state[13 as any]] ^ AESKey.XtimeD[this.state[14 as any]] ^ AESKey.Xtime9[this.state[15 as any]];
         this.tmp[1] = AESKey.Xtime9[this.state[12 as any]] ^ AESKey.XtimeE[this.state[13 as any]] ^ AESKey.XtimeB[this.state[14 as any]] ^ AESKey.XtimeD[this.state[15 as any]];
         this.tmp[6] = AESKey.XtimeD[this.state[12 as any]] ^ AESKey.Xtime9[this.state[13 as any]] ^ AESKey.XtimeE[this.state[14 as any]] ^ AESKey.XtimeB[this.state[15 as any]];
         this.tmp[11] = AESKey.XtimeB[this.state[12 as any]] ^ AESKey.XtimeD[this.state[13 as any]] ^ AESKey.Xtime9[this.state[14 as any]] ^ AESKey.XtimeE[this.state[15 as any]];
         for(AESKey.i = 0; AESKey.i < 4 * AESKey.Nb; AESKey.i++)
         {
            this.state[AESKey.i as any] = AESKey.InvSbox[this.tmp[AESKey.i as any]];
         }
      }
      ...
      private expandKey(): void
      {
         ...
         for(idx = Nk; idx < AESKey.Nb * (this.Nr + 1); idx++)
         {
            ...
            {
               tmp4 = tmp3;
               tmp3 = uint(AESKey.Sbox[tmp0 as any]);
               tmp0 = uint(AESKey.Sbox[tmp1 as any] ^ AESKey.Rcon[idx / Nk as any]);
               tmp1 = uint(AESKey.Sbox[tmp2 as any]);
               tmp2 = uint(AESKey.Sbox[tmp4 as any]);
            }
            else if(Nk > 6 && idx % Nk == 4)
            {
               tmp0 = uint(AESKey.Sbox[tmp0 as any]);
               tmp1 = uint(AESKey.Sbox[tmp1 as any]);
               tmp2 = uint(AESKey.Sbox[tmp2 as any]);
               tmp3 = uint(AESKey.Sbox[tmp3 as any]);
            }
      ...
      protected addRoundKey(key: ByteArray, offset: number): void
      {
         ...
         {
            this.state[idx as any] ^= key[idx + offset as any];
         }
      }
      ...
      {
         this.tmp.length = 0;
         this.tmp[0] = AESKey.Xtime2Sbox[this.state[0 as any]] ^ AESKey.Xtime3Sbox[this.state[5 as any]] ^ AESKey.Sbox[this.state[10 as any]] ^ AESKey.Sbox[this.state[15 as any]];
         this.tmp[1] = AESKey.Sbox[this.state[0 as any]] ^ AESKey.Xtime2Sbox[this.state[5 as any]] ^ AESKey.Xtime3Sbox[this.state[10 as any]] ^ AESKey.Sbox[this.state[15 as any]];
         this.tmp[2] = AESKey.Sbox[this.state[0 as any]] ^ AESKey.Sbox[this.state[5 as any]] ^ AESKey.Xtime2Sbox[this.state[10 as any]] ^ AESKey.Xtime3Sbox[this.state[15 as any]];
         this.tmp[3] = AESKey.Xtime3Sbox[this.state[0 as any]] ^ AESKey.Sbox[this.state[5 as any]] ^ AESKey.Sbox[this.state[10 as any]] ^ AESKey.Xtime2Sbox[this.state[15 as any]];
         this.tmp[4] = AESKey.Xtime2Sbox[this.state[4 as any]] ^ AESKey.Xtime3Sbox[this.state[9 as any]] ^ AESKey.Sbox[this.state[14 as any]] ^ AESKey.Sbox[this.state[3 as any]];
         this.tmp[5] = AESKey.Sbox[this.state[4 as any]] ^ AESKey.Xtime2Sbox[this.state[9 as any]] ^ AESKey.Xtime3Sbox[this.state[14 as any]] ^ AESKey.Sbox[this.state[3 as any]];
         this.tmp[6] = AESKey.Sbox[this.state[4 as any]] ^ AESKey.Sbox[this.state[9 as any]] ^ AESKey.Xtime2Sbox[this.state[14 as any]] ^ AESKey.Xtime3Sbox[this.state[3 as any]];
         this.tmp[7] = AESKey.Xtime3Sbox[this.state[4 as any]] ^ AESKey.Sbox[this.state[9 as any]] ^ AESKey.Sbox[this.state[14 as any]] ^ AESKey.Xtime2Sbox[this.state[3 as any]];
         this.tmp[8] = AESKey.Xtime2Sbox[this.state[8 as any]] ^ AESKey.Xtime3Sbox[this.state[13 as any]] ^ AESKey.Sbox[this.state[2 as any]] ^ AESKey.Sbox[this.state[7 as any]];
         this.tmp[9] = AESKey.Sbox[this.state[8 as any]] ^ AESKey.Xtime2Sbox[this.state[13 as any]] ^ AESKey.Xtime3Sbox[this.state[2 as any]] ^ AESKey.Sbox[this.state[7 as any]];
         this.tmp[10] = AESKey.Sbox[this.state[8 as any]] ^ AESKey.Sbox[this.state[13 as any]] ^ AESKey.Xtime2Sbox[this.state[2 as any]] ^ AESKey.Xtime3Sbox[this.state[7 as any]];
         this.tmp[11] = AESKey.Xtime3Sbox[this.state[8 as any]] ^ AESKey.Sbox[this.state[13 as any]] ^ AESKey.Sbox[this.state[2 as any]] ^ AESKey.Xtime2Sbox[this.state[7 as any]];
         this.tmp[12] = AESKey.Xtime2Sbox[this.state[12 as any]] ^ AESKey.Xtime3Sbox[this.state[1 as any]] ^ AESKey.Sbox[this.state[6 as any]] ^ AESKey.Sbox[this.state[11 as any]];
         this.tmp[13] = AESKey.Sbox[this.state[12 as any]] ^ AESKey.Xtime2Sbox[this.state[1 as any]] ^ AESKey.Xtime3Sbox[this.state[6 as any]] ^ AESKey.Sbox[this.state[11 as any]];
         this.tmp[14] = AESKey.Sbox[this.state[12 as any]] ^ AESKey.Sbox[this.state[1 as any]] ^ AESKey.Xtime2Sbox[this.state[6 as any]] ^ AESKey.Xtime3Sbox[this.state[11 as any]];
         this.tmp[15] = AESKey.Xtime3Sbox[this.state[12 as any]] ^ AESKey.Sbox[this.state[1 as any]] ^ AESKey.Sbox[this.state[6 as any]] ^ AESKey.Xtime2Sbox[this.state[11 as any]];
         this.state.position = 0;
         this.state.writeBytes(tmp,0,AESKey.Nb * 4);
      }
      
      protected shiftRows(): void
      {
         var tmp: number = 0;
         this.state[0] = AESKey.Sbox[this.state[0 as any]];
         this.state[4] = AESKey.Sbox[this.state[4 as any]];
         this.state[8] = AESKey.Sbox[this.state[8 as any]];
         this.state[12] = AESKey.Sbox[this.state[12 as any]];
         tmp = uint(AESKey.Sbox[this.state[1 as any]]);
         this.state[1] = AESKey.Sbox[this.state[5 as any]];
         this.state[5] = AESKey.Sbox[this.state[9 as any]];
         this.state[9] = AESKey.Sbox[this.state[13 as any]];
         this.state[13] = tmp;
         tmp = uint(AESKey.Sbox[this.state[2 as any]]);
         this.state[2] = AESKey.Sbox[this.state[10 as any]];
         this.state[10] = tmp;
         tmp = uint(AESKey.Sbox[this.state[6 as any]]);
         this.state[6] = AESKey.Sbox[this.state[14 as any]];
         this.state[14] = tmp;
         tmp = uint(AESKey.Sbox[this.state[15 as any]]);
         this.state[15] = AESKey.Sbox[this.state[11 as any]];
         this.state[11] = AESKey.Sbox[this.state[7 as any]];
         this.state[7] = AESKey.Sbox[this.state[3 as any]];
         this.state[3] = tmp;
      }
