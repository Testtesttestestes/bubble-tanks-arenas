...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(key: ISymmetricKey, padding: IPad = null){
         ...
         if(padding == null)
         {
            padding = new (PKCS5 as any)(key.getBlockSize());
         }
         else
         {
      ...
      public encrypt(src: ByteArray): void
      {
         ...
         tmp = new (ByteArray as any)();
         dst = new (ByteArray as any)();
      ...
      public decrypt(src: ByteArray): void
      {
         ...
         {
            throw new (Error as any)("ECB mode cipher length must be a multiple of blocksize " + blockSize);
         }
         tmp = new (ByteArray as any)();
         dst = new (ByteArray as any)();
         for(i = 0; i < src.length; i += blockSize)
