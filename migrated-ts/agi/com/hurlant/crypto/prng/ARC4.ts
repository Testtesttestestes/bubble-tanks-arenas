...
import { IStreamCipher } from '../symmetric/IStreamCipher';
...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public init(key: ByteArray): void
      {
         ...
         for(i = 0; i < 256; i++)
         {
            j = j + this.S[i as any] + key[i % key.length as any] & 0xFF;
            t = int(this.S[i as any]);
            this.S[i as any] = this.S[j as any];
            this.S[j as any] = t;
         }
         this.i = 0;
         this.j = 0;
      ...
      public encrypt(block: ByteArray): void
      {
         ...
         while(i < block.length)
         {
            ...
            var _loc3_: number = i++;
            _temp_2[_loc3_ as any] ^= this.next();
         }
      }
      ...
      public next(): number
      {
         ...
         t = int(this.S[this.i as any]);
         this.S[this.i as any] = this.S[this.j as any];
         this.S[this.j as any] = t;
         return this.S[t + this.S[this.i as any] & 0xFF];
      }
