...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: class_79, param2: Stage, param3: number = 0, param4: number = 0){
         ...
         var var_316: any, var_207: any, var_493: any, var_326: any, var_387: any, var_446: any, var_321: any, var_263: any, var_500: any, var_537: any;
         ...
         this.updateStart = 30;
         this.updateLeft = 30;
         this.mRef.addEventListener("enterframe", this.Run.bind(this));
         this.method_539();
      }
      ...
      {
         this.mRef.removeEventListener("enterframe", this.Run.bind(this));
      ...
      private Run(param1: any): void
      {
         ...
         if(this.updateLeft == 0)
         {
            ...
            this.var_326 = Math.round(this.var_207 / ((Date.now() - this.timerStartValue) / 1000));
            this.var_207 = 0;
            this.timerStartValue = Date.now();
            this.var_321 = 2;
         }
      ...
      {
         var var_207: any, var_387: any, var_446: any, var_263: any;

         this.var_207 = 0;
         this.timerStartValue = 0;
         if(this.var_387 == true)
         {
            this.txtFrameText = new (TextField as any)();
            ...
            if(this.var_263 == 1)
            {
               (this.txtFrameText as any).x = 10;
               (this.txtFrameText as any).y = 10;
            }
            else if(this.var_263 == 2)
            {
               (this.txtFrameText as any).x = this.var_316.stageWidth - this.txtFrameText.width / 2;
               (this.txtFrameText as any).y = 10;
            }
            else if(this.var_263 == 3)
            {
               (this.txtFrameText as any).x = 10;
               (this.txtFrameText as any).y = this.var_316.stageHeight - this.txtFrameText.height / 3;
            }
            ...
            {
               (this.txtFrameText as any).x = this.var_500;
               (this.txtFrameText as any).y = this.var_537;
            }
