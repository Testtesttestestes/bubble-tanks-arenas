...
// @ts-ignore
  ...
  [key: string]: any;
    ...
    // @ts-ignore
    super(this.bData);
         this.bData = new (BitmapData as any)(param1,param2,true,0);
         this.var_365 = new (Rectangle as any)(0,0,param1,param2);
         this.SetBlur(4,4,2);
      ...
      {
         var _loc5_: Rectangle = new (Rectangle as any)(param1 - param3,param2 - param3,param3,param3);
      ...
      public method_290(): void
      {
         ...
         var _loc1_: Point = new (Point as any)();
      ...
      {
         this.bf = new (BlurFilter as any)(param1,param2,param3);
      }
      ...
      public Destroy(): void
      {
         ...
         this.bData = null as any;
         this.var_365 = null as any;
         this.bf = null as any;
      }
      
      public method_168(param1: number, param2: number, param3: number, param4: number): void
      {
         var _loc5_: Rectangle = new (Rectangle as any)(param1,param2,param3,param3);
         this.bData.fillRect(_loc5_,param4);
      }
      ...
      {
         var _loc5_: Rectangle = new (Rectangle as any)(param1 - param3 / 2,param2 - param3 / 2,param3 / 2,param3 / 2);
         this.bData.fillRect(_loc5_,param4);
      }
   }
