...
// @ts-ignore
export class Credits extends MovieClip{
  [key: string]: any;
      
      public back_btn!: MovieClip & Record<string, any>;
      public composer_link!: MovieClip & Record<string, any>;
      public hero_link!: MovieClip & Record<string, any>;
      constructor(){
         // @ts-ignore
         super();
         this.addFrameScript(33,this.frame34);
      }
