...
import { ArenaSelectScreenTutorial } from './ArenaSelectScreenTutorial';
import { ArenaSlot } from './ArenaSlot';
import { ArenaSlot2 } from './ArenaSlot2';
import { ArenaSlot3 } from './ArenaSlot3';
import { class_3 } from './class_3';
import { class_57 } from './class_57';
...
export class ArenaSelectScreen extends MovieClip{
  [key: string]: any;
      ...
      private var_9!: any;
      public inner!: MovieClip & Record<string, any>;
      ...
      public var_109!: MovieClip & Record<string, any>;
      private var_143!: any;
      private blnHeroSeverDown!: boolean;
      private var_312!: boolean;
      private var_363!: MovieClip & Record<string, any>;
      ...
      private var_423!: MovieClip & Record<string, any>;
      private var_457!: any;
      ...
      public aSlot!: MovieClip & Record<string, any>;
      constructor(){
         var var_476: any, var_372: any, var_340: any, var_322: any, var_19: any, var_216: any, var_36: any, var_32: any, var_256: any, var_135: any, var_258: any, var_443: any, var_417: any, var_283: any, var_52: any, var_457: any;
         ...
         this.var_52 = new (Array as any)();
         this.var_457 = new (Array as any)();
         this.arrSingleArenaID = new (Array as any)();
      }
      
      private btnUp2(param1: any): void
      {
      ...
      {
         var var_189: any, var_112: any, var_258: any;
         ...
         if(this.strCurrentLevelType != param1 || param2 == true)
         {
            ...
            if(param1 == "bta")
            {
               (this.inner.level_connect as any).y = 226;
               this.inner.right_box.gotoAndStop("bta");
               (this.inner.right_box.scrollBar as any).x = 325;
               (this.inner.right_box.scrollBar as any).y = 27;
               ...
               (this.inner.right_box.arenaSlotLoader as any).x = 8;
               (this.inner.right_box.arenaSlotLoader as any).y = 32;
               (this.inner.right_box.upArrow_mc as any).x = 323;
               (this.inner.right_box.downArrow_mc as any).x = 341;
            }
            else if(param1 == "server")
            {
               (this.inner.level_connect as any).y = 252;
               this.inner.right_box.gotoAndStop("server");
               (this.inner.right_box.scrollBar as any).x = 387;
               (this.inner.right_box.scrollBar as any).y = 27;
               (this.inner.right_box.upArrow_mc as any).x = 1000;
               (this.inner.right_box.downArrow_mc as any).x = 1000;
               (this.inner.right_box.arenaSlotLoader as any).x = 387;
               (this.inner.right_box.arenaSlotLoader as any).y = 63;
            }
            else if(param1 == "local")
            {
               (this.inner.level_connect as any).y = 278;
      ...
      {
         var var_126: class_11;
         var var_150: ByteArray;
         var var_157: URLRequest;
         var var_257: URLVariables;
         var var_243: URLLoader;
         var var_411: ByteArray;
         var var_563: class_12;
         var var_572: number;
         var var_562: string;
         var var_587: string;
         var var_549: any = null as any;
         var var_262: any = param1;
         var var_56: any = param2;
         var var_106: string = "";
         var var_194: string = "";
         var var_307: any = new (Array as any)();
         var var_40: any = new (Array as any)();
         var var_346: number = 0;
         while(var_346 < var_262.length)
         {
            var_549 = this.method_571(var_262[var_346 as any]);
         ...
         {
            var_549 = this.method_560(var_56[var_572 as any]);
         ...
         var_157 = new (URLRequest as any)(var_562);
      ...
      private btnUp(param1: any): void
      {
         ...
         var _loc5_: number = 0;
         var _loc6_: number = 0;
         var _loc7_: TankData = null as any;
         ...
         if(this.var_152 == false)
         {
            ...
            if(param1.target.name.substr(0,4) == "rate")
            {
               ...
               while(_loc3_ < 5)
               {
                  if(Number(param1.target.name.substr(4,1)) == _loc3_ + 1)
                  {
                     ...
                     {
                        if(this.var_9[_loc4_ as any].mc.hitTestPoint(this.mouseX,this.mouseY,true) == true)
                        {
                           if(this.var_9[_loc4_ as any].mc.currentFrame == 41)
                           {
                              return;
                           }
                           if(this.var_312 == true)
                           {
                              ...
                              while(_loc5_ < 5)
                              {
                                 this.var_9[_loc4_ as any].mc["rate" + (_loc5_ + 1)].selected_mc.gotoAndStop("off");
                                 _loc5_++;
                              }
                              _loc5_ = 0;
                              while(_loc5_ < 5)
                              {
                                 this.var_9[_loc4_ as any].mc["rate" + (_loc5_ + 1)].selected_mc.gotoAndStop("on");
                                 if(_loc5_ == _loc3_)
                                 {
                                    break;
                                 }
                              ...
                              this.RateArena(Number(this.var_9[_loc4_ as any].mc.name.substr(6)) + 1,_loc3_ + 1);
                              return;
                           }
                        }
                        _loc4_++;
            ...
            else if(param1.target.name.substr(0,5) == "aSlot")
            {
               ...
               {
                  if(this.var_9[_loc6_ as any].mc == param1.target)
                  {
                     if(param1.target.currentFrame == 41)
                     {
                        return;
                     }
                     if(this.mRef.blnBTAUnlocked == true || this.var_9[_loc6_ as any].blnLocked == false)
                     {
            ...
            else if(param1.target.name == "changeProfile_btn")
            {
               if(this.var_32 > 1)
               {
                  if(this.blnSelectNewProfile == false)
                  {
                     ...
                     if(this.var_32 == 2)
                     {
                        (this.inner.top_left.inside.profile_slots.p_slot1 as any).alpha = 1;
                     ...
                     {
                        (this.inner.top_left.inside.profile_slots.p_slot1 as any).alpha = 1;
                        (this.inner.top_left.inside.profile_slots.p_slot2 as any).alpha = 1;
                        this.inner.top_left.inside.profile_slots.v1_txt.text = ">";
            ...
            else if(param1.target.name == "p_slot1")
            {
               if(this.blnSelectNewProfile == true)
               {
                  ...
                  if(this.var_32 == 2)
                  {
                     (this.inner.top_left.inside.profile_slots.p_slot1 as any).alpha = 0;
                     this.inner.top_left.inside.profile_slots.v1_txt.text = "";
                  ...
                  {
                     (this.inner.top_left.inside.profile_slots.p_slot1 as any).alpha = 0;
                     (this.inner.top_left.inside.profile_slots.p_slot2 as any).alpha = 0;
                     this.inner.top_left.inside.profile_slots.v1_txt.text = "";
                     this.inner.top_left.inside.profile_slots.v2_txt.text = "";
                     this.inner.top_left.inside.profile_slots.profileName2_txt.text = "";
      ...
      private method_178(param1: any): void
      {
         param1.target.text = "";
         param1.target.removeEventListener("focusin", this.method_178.bind(this));
      }
      ...
      private btnOut2(param1: any): void
      {
      ...
      private stageUp(param1: any): void
      {
         var var_9: any;
         ...
         if(param1.target.name == "server_overlay" || param1.target.name == "play_mc" || param1.target.name == "trophy_mc" || param1.target.name == "score_txt" || param1.target.name == "arena_name_txt" || param1.target.name == "difficulty_txt" || param1.target.name == "bubble_fields_txt" || param1.target.name == "total_enemies_txt" || param1.target.name == "rating_txt")
         {
            ...
            {
               if(this.var_9[_loc2_ as any].mc.hitTestPoint(this.mouseX,this.mouseY,true) == true)
               {
                  if(this.var_9[_loc2_ as any].mc.currentFrame != 41)
                  {
         ...
         {
            if(this.inner.right_box.scrollBar.hitTestPoint(this.mouseX,this.mouseY,true) == false)
            {
               this.var_152 = false;
      ...
      {
         var var_457: any, var_52: any, var_216: any, var_36: any, var_380: any;
         ...
         this.arrSearchFilters.push("page=" + this.var_216 as any);
         if(param1 != "")
         {
            this.arrSearchFilters.push("id=" + param1 as any);
         }
         if(this.inner.search_sort_mc.diff1.currentFrame == 3)
         {
            this.arrSearchFilters.push("difficulty>" + this.mRef.gData.var_514 as any);
            this.arrSearchFilters.push("difficulty<" + this.mRef.gData.var_468 as any);
         }
         else if(this.inner.search_sort_mc.diff2.currentFrame == 3)
         {
            this.arrSearchFilters.push("difficulty>" + this.mRef.gData.var_468 as any);
            this.arrSearchFilters.push("difficulty<" + this.mRef.gData.var_438 as any);
         }
         else if(this.inner.search_sort_mc.diff3.currentFrame == 3)
         {
            this.arrSearchFilters.push("difficulty>" + this.mRef.gData.var_438 as any);
            this.arrSearchFilters.push("difficulty<" + this.mRef.gData.var_427 as any);
         }
         else if(this.inner.search_sort_mc.diff4.currentFrame == 3)
         {
            this.arrSearchFilters.push("difficulty>" + this.mRef.gData.var_427 as any);
            this.arrSearchFilters.push("difficulty<" + this.mRef.gData.var_525 as any);
         }
         ...
         {
            this.arrSearchFilters.push("name=" + this.inner.search_sort_mc.name_txt.text as any);
         }
         _loc2_ = false;
         var _loc4_: number = 0;
         ...
         {
            this.arrSearchFilters.push("author=" + this.inner.search_sort_mc.author_txt.text as any);
         }
         this.arrSearchSorts.push("rating descending" as any);
         this.arrSearchSorts.push("id ascending" as any);
      ...
      public SearchMenu(): void
      {
         ...
         this.inner.search_sort_mc.name_txt.addEventListener("focusin", this.method_178.bind(this));
         this.inner.search_sort_mc.author_txt.addEventListener("focusin", this.method_178.bind(this));
      }
      
      private scrollBarUp(param1: any): void
      {
         var var_152: any;
      ...
      {
         var var_52: any, var_9: any;

         var _loc3_: number = 0;
         var _loc4_: number = 0;
         param1--;
         if(this.var_52[param1 as any] != null)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_9.length)
            {
               this.var_9[_loc3_ as any].mc.play_mc.gotoAndStop("off");
               _loc3_++;
            }
            _loc4_ = 0;
            while(_loc4_ < 4)
            {
               if(this.var_52[param1 + _loc4_ as any] != null)
               {
                  if(param2 == false)
                  {
                     this.var_9[_loc4_ as any].mc.gotoAndStop("off");
                     this.method_210(this.var_9[_loc4_ as any].mc,param1 + _loc4_);
                  }
               }
               else if(param2 == false)
               {
                  this.var_9[_loc4_ as any].mc.gotoAndStop("empty");
               }
               _loc4_++;
            }
         }
      ...
      private btnOver(param1: any): void
      {
         ...
         if(param1.target.name == "server_overlay" || param1.target.name == "rate1" || param1.target.name == "rate2" || param1.target.name == "rate3" || param1.target.name == "rate4" || param1.target.name == "rate5" || param1.target.name == "play_mc" || param1.target.name == "trophy_mc" || param1.target.name == "score_txt" || param1.target.name == "arena_name_txt" || param1.target.name == "difficulty_txt" || param1.target.name == "bubble_fields_txt" || param1.target.name == "total_enemies_txt" || param1.target.name == "rating_txt")
         {
            ...
            while(_loc2_ < this.var_9.length)
            {
               if(this.var_9[_loc2_ as any].mc.hitTestPoint(this.mouseX,this.mouseY,true) == true)
               {
                  ...
                  this.var_363 = this.var_9[_loc2_ as any].mc;
                  if(param1.target.name.substr(0,4) == "rate")
                  {
                     _loc4_ = 0;
                     while(_loc4_ < 5)
                     {
                        this.var_9[_loc2_ as any].mc["rate" + (_loc4_ + 1)].star.gotoAndStop("on");
                  ...
                  if(this.mRef.blnBTAUnlocked == true || this.var_9[_loc2_ as any].blnLocked == false)
                  {
                     this.var_9[_loc2_ as any].mc.gotoAndStop("on");
                  }
                  this.var_9[_loc2_ as any].mc.play_mc.gotoAndStop("on");
               }
               _loc2_++;
            }
         }
         else if(param1.target.name.substr(0,5) == "aSlot")
         {
            ...
            {
               if(this.var_9[_loc5_ as any].mc == param1.target)
               {
                  ...
                  if(this.mRef.blnBTAUnlocked == true || this.var_9[_loc5_ as any].blnLocked == false)
                  {
                     if(this.var_9[_loc5_ as any].mc.currentFrame != 41)
                     {
                        var _loc6_: number = 0;
                        ...
                        if(this.mRef.blnBTAUnlocked == true || this.var_9[_loc5_ as any].blnLocked == false)
                        {
                           this.var_9[_loc5_ as any].mc.gotoAndStop("on");
                        }
                        this.var_9[_loc5_ as any].mc.play_mc.gotoAndStop("on");
                     }
                  }
               }
               else if(this.var_9[_loc5_ as any].mc.currentFrame != 41)
               {
                  if(this.mRef.blnBTAUnlocked == true || this.var_9[_loc5_ as any].blnLocked == false)
                  {
                     this.var_9[_loc5_ as any].mc.gotoAndStop("off");
                  }
                  this.var_9[_loc5_ as any].mc.play_mc.gotoAndStop("off");
               }
               _loc5_++;
            }
         }
         ...
         {
            this.var_363 = null as any;
            if(param1.target.name != "scrollBar")
            {
               if(this.var_152 == true)
               {
                  _loc7_ = new (Array as any)();
                  _loc7_.push(this.inner.BTALevels_btn as any);
                  _loc7_.push(this.inner.serverLevels_btn as any);
                  _loc7_.push(this.inner.localLevels_btn as any);
                  _loc7_.push(this.inner.createArenas_btn as any);
                  _loc7_.push(this.inner.createEnemy_btn as any);
                  _loc7_.push(this.inner.mm_btn as any);
                  _loc7_.push(this.inner.right_box.upArrow_mc as any);
                  _loc7_.push(this.inner.right_box.downArrow_mc as any);
                  _loc7_.push(this.inner.changeProfile_btn as any);
                  _loc7_.push(this.inner.top_left.inside.profile_slots.p_slot1 as any);
                  _loc7_.push(this.inner.top_left.inside.profile_slots.p_slot2 as any);
                  _loc7_.push(this.inner.top_left.inside.changeAvatar_btn as any);
                  _loc7_.push(this.inner.top_left.inside.editAvatar_btn as any);
                  _loc8_ = true;
                  _loc9_ = 0;
                  while(_loc9_ < _loc7_.length)
                  {
                     if(_loc7_[_loc9_ as any] == param1.target)
                     {
                        _loc8_ = false;
                     }
                     _loc9_++;
                  ...
                  if(_loc8_ == true)
                  {
                     ...
                     while(_loc10_ < this.var_9.length)
                     {
                        ...
                        while(_loc11_ < 5)
                        {
                           this.var_9[_loc10_ as any].mc["rate" + (_loc11_ + 1)].selected_mc.gotoAndStop("off");
                           _loc11_++;
                        }
                        this.var_9[_loc10_ as any].mc.play_mc.gotoAndStop("off");
                        _loc10_++;
                     }
                     this.inner.right_box.scrollBar.gotoAndPlay("toOff");
                     this.inner.right_box.upArrow_mc.gotoAndStop("off");
      ...
      private method_560(param1: string): any
      {
         ...
         var _loc6_: string = param1.substr(0,_loc3_);
         var _loc7_: string = param1.substr(_loc3_ + 1);
         if(_loc6_ == "id")
         {
            _loc4_ = "1";
         }
      ...
      {
         var var_189: any, var_112: any, var_14: any;

         this.mRef.gData.var_189 = this.var_112;
         this.mRef.SaveGameData();
         var _loc4_: ArenaData = new (ArenaData as any)();
         ...
         {
            if(this.mRef.gData.var_14[param1 - 1 as any] != null)
            {
               if(this.mRef.blnBTAUnlocked == true || this.mRef.gData.var_14[param1 - 1 as any].blnLocked == false)
               {
                  _loc4_.ImportArenaData(this.mRef.gData.var_14[param1 - 1 as any].arenaData);
                  this.strSelectedArenaName = _loc4_.strName;
                  var _loc2_: string = this.mRef.gData.var_14[param1 - 1 as any].ID;
                  var _loc8_: string = this.mRef.gData.var_14[param1 - 1 as any].AllTanks;
                  var _loc9_: number = 0;
                  while(0 < "".length)
                  {
                     if("".substr(0,1) != ",")
                     {
                        var _loc7_: string = "" + "".substr(0,1);
                     }
                     else
                     {
         ...
         {
            this.strSelectedArenaName = this.var_52[this.var_36 * 4 - 4 + param1 - 1 as any].name;
            _loc2_ = this.var_52[this.var_36 * 4 - 4 + param1 - 1 as any].id;
            this.ValidateArenaID("");
         }
         else if(this.strCurrentLevelType == "local")
         {
            _loc4_.ImportArenaData(this.var_143[param1 - 1 as any].Data);
            this.strSelectedArenaName = _loc4_.strName;
            _loc2_ = this.var_143[param1 - 1 as any].ID;
            _loc8_ = this.var_143[param1 - 1 as any].AllTanks;
            _loc9_ = 0;
            while(0 < "".length)
            {
               if("".substr(0,1) != ",")
      ...
      public ValidateArenaID(param1: string): void
      {
         ...
         _loc2_.push("page=1" as any);
         _loc2_.push("id=" + param1 as any);
         _loc3_.push("id ascending" as any);
      ...
      {
         var var_203: any, var_516: any, var_185: any;
         ...
         this.var_152 = false;
         this.var_312 = true;
         this.var_143 = new (Array as any)();
         this.var_9 = new (Array as any)();
         ...
         this.objButtonController = new (class_3 as any)();
         ...
         this.objButtonController2 = new (class_3 as any)();
         ...
         if(this.mRef.objCurrentPlayer.var_185 == 1)
         {
            ...
            this.var_19 = new (ArenaSelectScreenTutorial as any)();
            (this.var_19 as any).x = (this.var_19 as any).y = 0;
         ...
         else if(this.mRef.objCurrentPlayer.var_178 == 1)
         {
            ...
            this.var_19 = new (class_57 as any)();
            (this.var_19 as any).x = (this.var_19 as any).y = 0;
            this.addChild(this.var_19);
            this.objTutorialButtonController = new (class_3 as any)();
      ...
      private btnOut(param1: any): void
      {
         ...
         if(param1.target.name == "server_overlay" || param1.target.name == "rate1" || param1.target.name == "rate2" || param1.target.name == "rate3" || param1.target.name == "rate4" || param1.target.name == "rate5" || param1.target.name == "trophy_mc" || param1.target.name == "score_txt" || param1.target.name == "arena_name_txt" || param1.target.name == "difficulty_txt" || param1.target.name == "bubble_fields_txt" || param1.target.name == "total_enemies_txt" || param1.target.name == "rating_txt")
         {
            ...
            while(_loc3_ < this.var_9.length)
            {
               if(this.var_9[_loc3_ as any].mc.hitTestPoint(this.mouseX,this.mouseY,true) == true)
               {
                  if(this.var_9[_loc3_ as any].mc.currentFrame == 41)
                  {
                     return;
                  }
                  if(param1.target.name.substr(0,4) == "rate")
                  {
                     ...
                     while(_loc4_ < 5)
                     {
                        if(this.var_9[_loc3_ as any].mc.currentFrame != 41)
                        {
                           this.var_9[_loc3_ as any].mc["rate" + (_loc4_ + 1)].star.gotoAndStop("off");
                        }
                        _loc4_++;
                     }
                  }
                  ...
                  {
                     this.var_9[_loc3_ as any].mc.play_mc.gotoAndStop("off");
                     if(this.mRef.blnBTAUnlocked == true || this.var_9[_loc3_ as any].blnLocked == false)
                     {
                        this.var_9[_loc3_ as any].mc.gotoAndStop("on");
                     }
                  }
               }
               _loc3_++;
         ...
         else
         {
            ...
            while(_loc6_ < this.var_9.length)
            {
               this.var_9[_loc6_ as any].mc.play_mc.gotoAndStop("off");
               _loc6_++;
            }
            param1.target.gotoAndStop("off");
         }
         ...
         while(_loc2_ < this.var_9.length)
         {
            this.var_9[_loc2_ as any].mc.play_mc.gotoAndStop("off");
            _loc2_++;
         }
      }
      ...
      {
         var var_44: any, var_14: any;

         var _loc7_: number = 0;
         var _loc8_: string = null as any;
         var _loc9_: number = 0;
         var _loc10_: number = 0;
         var _loc11_: number = 0;
         var _loc12_: boolean = false;
         var _loc13_: any = null as any;
         var _loc14_: number = 0;
         var _loc15_: number = 0;
         var _loc16_: number = 0;
         var _loc17_: number = 0;
         var _loc3_: ArenaData = new (ArenaData as any)();
         ...
         if(this.strCurrentLevelType == "bta")
         {
            param1.arena_name_txt.text = this.mRef.gData.var_44[param2 as any].name;
            param1.difficulty_txt.text = this.mRef.gData.var_44[param2 as any].diff;
            param1.bubble_fields_txt.text = this.mRef.gData.var_44[param2 as any].bubblefields;
            param1.total_enemies_txt.text = this.mRef.gData.var_44[param2 as any].numEnemies;
            param1.description_txt.text = this.mRef.gData.var_44[param2 as any].desc;
            _loc6_ = 0;
            while(_loc6_ < this.mRef.objCurrentPlayer.arrBeatArenaIDs.length)
            {
               if(this.mRef.objCurrentPlayer.arrBeatArenaIDs[_loc6_ as any] == this.mRef.gData.var_14[param2 as any].ID)
               {
            ...
            {
               if(this.mRef.objCurrentPlayer.var_82[_loc5_ as any].id == this.mRef.gData.var_14[param2 as any].ID)
               {
                  param1.score_txt.text = this.mRef.objCurrentPlayer.var_82[_loc5_ as any].score.toString();
                  _loc4_ = true;
                  break;
               }
               _loc5_++;
         ...
         else if(this.strCurrentLevelType == "server")
         {
            if(this.var_476 == false)
            {
               ...
               {
                  if(this.var_52[param2 as any] != null && this.var_52[param2 as any] != undefined)
                  {
                     ...
                     while(_loc6_ < this.mRef.objCurrentPlayer.arrBeatArenaIDs.length)
                     {
                        if(this.mRef.objCurrentPlayer.arrBeatArenaIDs[_loc6_ as any] == this.var_52[param2 as any].id)
                        {
                           param1.trophy_mc.gotoAndStop("on");
                           break;
                        }
                     ...
                     param1.arena_name_txt.text = "" + this.var_52[param2 as any].name;
                     param1.author_txt.text = "" + this.var_52[param2 as any].author;
                     param1.difficulty_txt.text = "" + this.var_52[param2 as any].difficulty.toString();
                     param1.bubble_fields_txt.text = "" + this.var_52[param2 as any].bubblefields.toString();
                     param1.total_enemies_txt.text = "" + this.var_52[param2 as any].enemies.toString();
                     param1.rating_txt.text = "" + this.var_52[param2 as any].rating.toString();
                     _loc8_ = this.var_52[param2 as any].id;
                     _loc9_ = 0;
                     while(_loc9_ < this.var_112.length)
                     {
                        if(this.var_52[param2 as any] != null)
                        {
                           if(this.var_112[_loc9_ as any].id == _loc8_)
                           {
                              _loc11_ = 0;
                              while(_loc11_ < this.var_112[_loc9_ as any].rating)
                              {
                     ...
                     {
                        if(this.mRef.objCurrentPlayer.var_82[_loc10_ as any].id == this.var_52[param2 as any].id)
                        {
                           param1.score_txt.text = this.mRef.objCurrentPlayer.var_82[_loc10_ as any].score.toString();
                           _loc4_ = true;
                           break;
                        }
                        _loc10_++;
         ...
         else if(this.strCurrentLevelType == "local")
         {
            ...
            {
               if(this.mRef.var_305[_loc14_ as any].ID == this.var_143[param2 as any].ID)
               {
                  _loc12_ = true;
                  _loc13_ = this.mRef.var_305[_loc14_ as any];
                  break;
               }
               _loc14_++;
            }
            ...
            {
               if(this.mRef.objCurrentPlayer.arrBeatArenaIDs[_loc15_ as any] == this.var_143[param2 as any].ID)
               {
                  param1.trophy_mc.gotoAndStop("on");
                  break;
               }
            ...
            if(_loc12_ == false)
            {
               _loc3_.ImportArenaData(this.var_143[param2 as any].Data);
               ...
               {
                  _loc5_ = 0;
                  while(_loc5_ < _loc3_.var_6[_loc6_ as any].arrEnemies.length)
                  {
                     _loc17_ = int(_loc3_.var_6[_loc6_ as any].arrEnemies[_loc5_ as any].number);
                     _loc16_ += _loc17_;
                     _loc5_++;
                  }
                  _loc6_++;
               ...
               this.mRef.var_305.push({
                  "ID":this.var_143[param2 as any].ID,
            ...
            while(_loc5_ < this.mRef.objCurrentPlayer.var_82.length)
            {
               if(this.mRef.objCurrentPlayer.var_82[_loc5_ as any].id == this.var_143[param2 as any].ID)
               {
                  param1.score_txt.text = this.mRef.objCurrentPlayer.var_82[_loc5_ as any].score.toString();
                  _loc4_ = true;
                  break;
      ...
      private tut2Up(param1: any): void
      {
         var var_19: any;
      ...
      private method_360(): void
      {
         ...
         {
            if(this.arrSearchFilters[_loc1_ as any].substr(0,4) == "page")
            {
               this.arrSearchFilters[_loc1_ as any] = "page=" + this.var_216;
               break;
            }
            _loc1_++;
         }
      ...
      private method_391(param1: string, param2: number): void
      {
         ...
         var var_56: class_12;
         var var_106: string;
         var var_126: ByteArray;
         var var_157: string;
         var var_194: string;
         var var_262: class_11;
         var var_257: ByteArray;
         var var_243: URLRequest;
         var var_346: URLVariables;
         var var_150: string = param1;
         var var_307: number = param2;
         if(var_307 < 0)
         {
            var_307 = 0;
         }
         ...
         var_243 = new (URLRequest as any)(var_194);
         var_346 = new (URLVariables as any)();
         var_346.r = var_106;
      ...
      private method_719(): void
      {
         ...
         if(this.strCurrentLevelType == "bta")
         {
            ...
            {
               if(this.mRef.gData.var_14[_loc2_ as any].blnLocked == false)
               {
                  _loc1_ = _loc2_ + 1;
               }
               _loc2_++;
            ...
            {
               (this.inner.right_box.scrollBar as any).y = 40;
               (this.inner.right_box.arenaSlotLoader as any).y = -101;
            }
            else if(_loc1_ == 3)
            {
               (this.inner.right_box.scrollBar as any).y = 53;
               (this.inner.right_box.arenaSlotLoader as any).y = -234;
            }
            else if(_loc1_ == 4)
            {
               (this.inner.right_box.scrollBar as any).y = 66;
               (this.inner.right_box.arenaSlotLoader as any).y = -367;
            }
            else if(_loc1_ == 5)
            {
               (this.inner.right_box.scrollBar as any).y = 79;
               (this.inner.right_box.arenaSlotLoader as any).y = -500;
            }
            else if(_loc1_ == 6)
            {
               (this.inner.right_box.scrollBar as any).y = 92;
               (this.inner.right_box.arenaSlotLoader as any).y = -633;
            }
            else if(_loc1_ == 7)
            {
               (this.inner.right_box.scrollBar as any).y = 105;
               (this.inner.right_box.arenaSlotLoader as any).y = -766;
            }
            else if(_loc1_ == 8)
            {
               (this.inner.right_box.scrollBar as any).y = 118;
               (this.inner.right_box.arenaSlotLoader as any).y = -899;
            }
            else if(_loc1_ == 9)
            {
               (this.inner.right_box.scrollBar as any).y = 131;
               (this.inner.right_box.arenaSlotLoader as any).y = -1032;
            }
            else if(_loc1_ == 10)
            {
               (this.inner.right_box.scrollBar as any).y = 144;
               (this.inner.right_box.arenaSlotLoader as any).y = -1166;
            }
            else if(_loc1_ == 11)
            {
               (this.inner.right_box.scrollBar as any).y = 157;
               (this.inner.right_box.arenaSlotLoader as any).y = -1299;
            }
            else if(_loc1_ == 12)
            {
               (this.inner.right_box.scrollBar as any).y = 170;
               (this.inner.right_box.arenaSlotLoader as any).y = -1432;
            }
            else if(_loc1_ == 13)
            {
               (this.inner.right_box.scrollBar as any).y = 183;
               (this.inner.right_box.arenaSlotLoader as any).y = -1565;
            }
            else if(_loc1_ == 14)
            {
               (this.inner.right_box.scrollBar as any).y = 196;
               (this.inner.right_box.arenaSlotLoader as any).y = -1698;
            }
            else if(_loc1_ == 15)
            {
               (this.inner.right_box.scrollBar as any).y = 209;
               (this.inner.right_box.arenaSlotLoader as any).y = -1831;
            }
            else if(_loc1_ == 16)
            {
               (this.inner.right_box.scrollBar as any).y = 222;
               (this.inner.right_box.arenaSlotLoader as any).y = -1964;
            }
            else if(_loc1_ == 17)
            {
               (this.inner.right_box.scrollBar as any).y = 235;
               (this.inner.right_box.arenaSlotLoader as any).y = -2097;
            }
            else if(_loc1_ == 18)
            {
               (this.inner.right_box.scrollBar as any).y = 248;
               (this.inner.right_box.arenaSlotLoader as any).y = -2230;
            }
            else if(_loc1_ == 19)
            {
               (this.inner.right_box.scrollBar as any).y = 261;
               (this.inner.right_box.arenaSlotLoader as any).y = -2364;
            }
            else if(_loc1_ == 20)
            {
               (this.inner.right_box.scrollBar as any).y = 274;
               (this.inner.right_box.arenaSlotLoader as any).y = -2497;
            }
            else if(_loc1_ == 21)
            {
               (this.inner.right_box.scrollBar as any).y = 287;
               (this.inner.right_box.arenaSlotLoader as any).y = -2630;
            }
            else if(_loc1_ == 22)
            {
               (this.inner.right_box.scrollBar as any).y = 300;
               (this.inner.right_box.arenaSlotLoader as any).y = -2763;
            }
            else if(_loc1_ == 23)
            {
               (this.inner.right_box.scrollBar as any).y = 311;
               (this.inner.right_box.arenaSlotLoader as any).y = -2876;
            }
            else if(_loc1_ == 24)
            {
               (this.inner.right_box.scrollBar as any).y = 311;
      ...
      {
         var var_189: any, var_112: any, var_36: any;

         this.mRef.gData.var_189 = this.var_112;
         this.mRef.SaveGameData();
         var _loc2_: number = this.var_36;
         if(param1 == 1)
         {
            if(this.var_36 > 1)
            {
         ...
         {
            this.method_264(uint(this.var_36 * 4 - 3));
            this.method_264(uint((this.var_36 + 1) * 4 - 3),true);
         }
      }
      ...
      private method_608(): void
      {
         ...
         if(this.var_152 == true)
         {
            _loc1_ = this.mouseY - this.inner.right_box.scrollBar.height / 2;
            if(_loc1_ < 27)
            {
               (this.inner.right_box.scrollBar as any).y = 27;
            }
            ...
            {
               (this.inner.right_box.scrollBar as any).y = _loc1_;
            }
            _loc2_ = (this.inner.right_box.scrollBar.y - 27) / 284;
            (this.inner.right_box.arenaSlotLoader as any).y = int(32 - this.var_362 * _loc2_);
         }
      }
      
      private method_356(): void
      {
         var var_443: any, var_52: any, var_372: any, var_417: any;
      ...
      private method_728(): void
      {
         ...
         if(this.strCurrentLevelType == "bta")
         {
            ...
            while(_loc2_ < this.var_9.length)
            {
               this.objButtonController.method_7(this.var_9[_loc2_ as any].mc);
               this.inner.right_box.arenaSlotLoader.removeChild(this.var_9[_loc2_ as any].mc);
               _loc4_ = 0;
               while(_loc4_ < 5)
               {
                  this.objButtonController.method_7(this.var_9[_loc2_ as any].mc["rate" + (_loc4_ + 1)]);
                  _loc4_++;
               }
               _loc2_++;
            }
            ...
            (this.inner.right_box.no_local_found as any).alpha = 0;
            _loc3_ = 0;
            while(_loc3_ < this.mRef.gData.var_14.length)
            {
               this.aSlot = new (ArenaSlot as any)();
               (this.aSlot as any).x = 0;
               (this.aSlot as any).y = _loc1_;
               this.aSlot.name = "aSlot_" + _loc3_;
               if(this.mRef.blnBTAUnlocked == true || this.mRef.gData.var_14[_loc3_ as any].blnLocked == false)
               {
               ...
               this.var_9.push({
                  "mc":this.aSlot,
                  "blnLocked":this.mRef.gData.var_14[_loc3_ as any].blnLocked
               } as any);
               if(this.mRef.blnBTAUnlocked == true || this.mRef.gData.var_14[_loc3_ as any].blnLocked == false)
               {
                  this.objButtonController.method_4(this.var_9[this.var_9.length - 1 as any].mc,true);
               }
               else
               {
                  this.var_9[this.var_9.length - 1 as any].mc.gotoAndStop("locked");
               }
               _loc3_++;
            }
            ...
            this.inner.right_box.scrollBar.addEventListener("mousedown", this.scrollBarDown.bind(this));
            this.addEventListener("mouseup", this.stageUp.bind(this));
            this.var_362 = int(32 - (32 - (this.inner.right_box.arenaSlotLoader.height - 410)));
            this.method_719();
         }
         else if(this.strCurrentLevelType == "server")
         {
            ...
            while(_loc5_ < this.var_9.length)
            {
               this.objButtonController.method_7(this.var_9[_loc5_ as any].mc);
               this.inner.right_box.arenaSlotLoader.removeChild(this.var_9[_loc5_ as any].mc);
               _loc6_ = 0;
               while(_loc6_ < 5)
               {
                  this.objButtonController.method_7(this.var_9[_loc5_ as any].mc["rate" + (_loc6_ + 1)]);
                  _loc6_++;
               }
               _loc5_++;
            }
            ...
            this.objButtonController.method_7(this.inner.right_box.downArrow_mc);
            this.objButtonController.method_7(this.inner.right_box.scrollBar);
            this.inner.right_box.scrollBar.removeEventListener("mousedown", this.scrollBarDown.bind(this));
            this.objButtonController.method_7(this.inner.right_box.page_up_btn);
            this.objButtonController.method_7(this.inner.right_box.page_down_btn);
            this.objButtonController.method_7(this.inner.right_box.page_top_btn);
            this.objButtonController.method_7(this.inner.right_box.load_ID);
            this.inner.removeEventListener("mouseup", this.btnUp.bind(this));
            (this.inner.right_box.arenaSlotLoader as any).x = 8;
            (this.inner.right_box.no_local_found as any).alpha = 0;
            if(this.var_52.length != 0)
            {
               ...
               while(_loc7_ < 4)
               {
                  this.aSlot = new (ArenaSlot2 as any)();
                  (this.aSlot as any).x = 0;
                  (this.aSlot as any).y = _loc1_;
                  ...
                  if(this.var_9[this.var_9.length - 1 as any].blnLocked == true)
                  {
                     this.var_9[this.var_9.length - 1 as any].mc.gotoAndStop("locked");
                  }
                  else
                  {
                     ...
                     while(_loc8_ < 5)
                     {
                        this.objButtonController.method_4(this.var_9[this.var_9.length - 1 as any].mc["rate" + (_loc8_ + 1)]);
                        _loc8_++;
                     }
                  }
                  this.objButtonController.method_4(this.var_9[this.var_9.length - 1 as any].mc,false);
                  _loc7_++;
               }
               ...
               this.objButtonController.method_4(this.inner.right_box.load_ID);
               this.inner.right_box.load_id_txt.addEventListener("focusin", this.method_178.bind(this));
            }
            else
            {
         ...
         else if(this.strCurrentLevelType == "local")
         {
            ...
            {
               this.objButtonController.method_7(this.var_9[_loc9_ as any].mc);
               this.inner.right_box.arenaSlotLoader.removeChild(this.var_9[_loc9_ as any].mc);
               _loc11_ = 0;
               while(_loc11_ < 5)
               {
                  this.objButtonController.method_7(this.var_9[_loc9_ as any].mc["rate" + (_loc11_ + 1)]);
                  _loc11_++;
               }
               _loc9_++;
            }
            ...
            {
               (this.inner.right_box.no_local_found as any).alpha = 0[42];
            }
            _loc10_ = 0;
            while(_loc10_ < this.var_143.length)
            {
               this.aSlot = new (ArenaSlot3 as any)();
               (this.aSlot as any).x = 0;
               (this.aSlot as any).y = _loc1_;
            ...
            {
               (this.inner.right_box.scrollBar as any).x = 1000;
               (this.inner.right_box.upArrow_mc as any).x = 1000;
               (this.inner.right_box.downArrow_mc as any).x = 1000;
            }
            else
      ...
      private PullInProfileTankData(): void
      {
         ...
         var _loc2_: number = _loc1_.method_383() * 2;
         var _loc3_: number = 85 / _loc2_;
         this.var_109.width *= _loc3_;
         this.var_109.height *= _loc3_;
         if(this.var_109.scaleX > 1 || this.var_109.scaleY > 1)
         {
            var _temp_4: any = this.var_109;
            var _temp_3: any = this.var_109;
            var _temp_2: any = 1;
            1;
            (_temp_3 as any).scaleY = _temp_2;
            (_temp_4 as any).scaleX = 1;
         }
      ...
      private method_755(param1: any): void
      {
      ...
      private method_186(param1: string): void
      {
         ...
         {
            (this.inner.right_box.scrollBar as any).y = _loc2_;
         }
         _loc3_ = (this.inner.right_box.scrollBar.y - 27) / 284;
         var _loc4_: number = 32 - this.var_362 * _loc3_;
         (this.inner.right_box.arenaSlotLoader as any).y = _loc4_;
      }
      
      private ChangeProfile(param1: number): void
      {
         var var_32: any, var_283: any, var_322: any;
         ...
         while(_loc2_ < this.mRef.objCurrentPlayer.var_38.length)
         {
            ...
            {
               if(this.mRef.gData.var_14[_loc7_ as any].ID == this.mRef.objCurrentPlayer.var_38[_loc2_ as any].ID)
               {
                  _loc6_ = true;
               }
               _loc7_++;
            ...
            if(_loc6_ == false)
            {
               this.var_143.push(this.mRef.objCurrentPlayer.var_38[_loc2_ as any] as any);
            }
            _loc2_++;
         }
         if(this.var_135 == 1)
      ...
      private method_763(param1: string): void
      {
         ...
         {
            if(this.inner.search_sort_mc[param1 as any].currentFrame == 3)
            {
               this.inner.search_sort_mc[param1 as any].gotoAndStop("off");
            }
            else
            {
               this.inner.search_sort_mc[param1 as any].gotoAndStop("select");
            }
         }
         else if(param1.substr(0,2) == "hi")
         {
            if(this.inner.search_sort_mc[param1 as any].name == "hi1")
            {
               this.inner.search_sort_mc.hi2.gotoAndStop("off");
            }
            else if(this.inner.search_sort_mc[param1 as any].name == "hi2")
            {
         ...
         {
            if(this.inner.search_sort_mc[param1 as any].name == "fa1")
            {
               this.inner.search_sort_mc.fa2.gotoAndStop("off");
            }
            else if(this.inner.search_sort_mc[param1 as any].name == "fa2")
            {
      ...
      private scrollBarDown(param1: any): void
      {
         var var_152: any;
      ...
      {
         var var_312: any, var_112: any, var_52: any, var_36: any;
         ...
         if(this.var_312 == true)
         {
            ...
            {
               if(this.var_52[this.var_36 * 4 - 4 + param1 - 1 as any].id == this.var_112[_loc3_ as any].id)
               {
                  _loc4_ = _loc3_;
               }
               _loc3_++;
            ...
            if(_loc4_ != -1)
            {
               if(param2 == this.var_112[_loc4_ as any].rating)
               {
                  this.var_112.splice(_loc4_,1);
                  _loc6_ = 0;
                  while(_loc6_ < 5)
                  {
                     this.var_9[param1 - 1 as any].mc["rate" + (_loc6_ + 1)].selected_mc.gotoAndStop("off");
                     _loc6_++;
                  }
               }
               else
               {
                  _loc5_ = this.var_52[this.var_36 * 4 - 4 + param1 - 1 as any].id;
                  this.var_112[_loc4_ as any].rating = param2;
      ...
      private btnOver2(param1: any): void
      {
         if(param1.target.currentFrame != 3)
         {
            param1.target.gotoAndStop("on");
