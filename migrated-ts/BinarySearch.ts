  ...
  [key: string]: any;
      ...
      public bSearch(param1: any, param2: number, param3: number): class_109
      {
         ...
         while(_loc4_ <= _loc5_)
         {
            ...
            if(param1[_loc6_ as any].xVal == param2)
            {
               _loc4_ = 0;
               _loc5_ = param1[_loc6_ as any].arrY.length - 1;
               while(_loc4_ <= _loc5_)
               {
                  _loc7_ = (_loc4_ + _loc5_) / 2;
                  if(param1[_loc6_ as any].arrY[_loc7_ as any].yVal == param3)
                  {
                     return param1[_loc6_ as any].arrY[_loc7_ as any].bfRef;
                  }
                  if(param1[_loc6_ as any].arrY[_loc7_ as any].yVal < param3)
                  {
                     _loc4_ = _loc7_ + 1;
            ...
            else if(param1[_loc6_ as any].xVal < param2)
            {
               _loc4_ = _loc6_ + 1;
            }
            else
