...
import { class_62 } from './class_62';
import { class_63 } from './class_63';
import { class_64 } from './class_64';
import { class_65 } from './class_65';
import { class_67 } from './class_67';
import { class_79 } from './class_79';
import { AGun2Parallel } from './Parts/AGun2Parallel';
import { AGun3ShotSpread } from './Parts/AGun3ShotSpread';
import { AGun5ShotSpread } from './Parts/AGun5ShotSpread';
import { AGunAreaBurstCannon } from './Parts/AGunAreaBurstCannon';
import { AGunAutoCannon } from './Parts/AGunAutoCannon';
import { AGunBasicCannon } from './Parts/AGunBasicCannon';
import { AGunBigCannon } from './Parts/AGunBigCannon';
import { AGunConversion } from './Parts/AGunConversion';
import { AGunMegaCannon } from './Parts/AGunMegaCannon';
import { AGunShield } from './Parts/AGunShield';
import { class_137 } from './Parts/class_137';
import { class_138 } from './Parts/class_138';
import { class_139 } from './Parts/class_139';
import { class_140 } from './Parts/class_140';
import { class_141 } from './Parts/class_141';
import { class_142 } from './Parts/class_142';
import { class_143 } from './Parts/class_143';
import { class_144 } from './Parts/class_144';
import { class_145 } from './Parts/class_145';
import { class_146 } from './Parts/class_146';
import { class_147 } from './Parts/class_147';
import { class_148 } from './Parts/class_148';
import { class_149 } from './Parts/class_149';
import { class_151 } from './Parts/class_151';
import { class_152 } from './Parts/class_152';
import { class_153 } from './Parts/class_153';
import { class_156 } from './Parts/class_156';
import { class_158 } from './Parts/class_158';
import { class_159 } from './Parts/class_159';
import { class_160 } from './Parts/class_160';
import { class_161 } from './Parts/class_161';
import { class_162 } from './Parts/class_162';
import { EGun350Spread } from './Parts/EGun350Spread';
import { EGun3ShotPar } from './Parts/EGun3ShotPar';
import { EGun3ShotSpread } from './Parts/EGun3ShotSpread';
import { EGun5ShotPar } from './Parts/EGun5ShotPar';
import { EGun5ShotSpread } from './Parts/EGun5ShotSpread';
import { EGunBasicSeekers } from './Parts/EGunBasicSeekers';
import { EGunEnemyBigCannon } from './Parts/EGunEnemyBigCannon';
import { EGunEnemyCannon } from './Parts/EGunEnemyCannon';
...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(){
         ...
         if(!var_255)
         {
            throw new (Error as any)("Error: Use GameObjectLibrary.getInstance() method!");
         }
         this.var_551 = 1;
         this.var_83 = new (Array as any)();
         this.var_569 = new (Array as any)();
         this.var_50 = new (Array as any)();
         this.var_62 = new (Array as any)();
         this.var_48 = new (Array as any)();
         this.var_12 = new (Array as any)();
         this.var_172 = new (Array as any)();
         this.arrClassData = new (Array as any)();
         this.var_102 = -1;
         this.var_104 = 0;
         this.method_714();
      }
      ...
      public static getInstance(): class_2
      {
         ...
         {
            var_255 = true;
            class_2.instance = new (class_2 as any)();
            var_255 = false;
         }
         return class_2.instance;
      }
      ...
      public method_714(): void
      {
         ...
         this.var_50.push({
            ...
            "strFlavorText":"The Super Machine Gun takes bubble machine guns to a whole new level.  Did we mention that it\'s this?",
            "intLocked":1,
            "blnAfford":true
         } as any);
         this.var_50.push({
      ...
      public GetClassData(param1: number): any
      {
         this.arrClassData.push({
            "intClass":6,
            "intArmor":3,
         ...
         {
            if(this.arrClassData[_loc2_ as any].intClass == param1)
            {
               return {
                  "armor":this.arrClassData[_loc2_ as any].intArmor,
                  "speed":this.arrClassData[_loc2_ as any].intSpeed
               };
            }
            _loc2_++;
         }
      ...
      public method_123(param1: number, param2: boolean = false): MovieClip
      {
         ...
         if(this.var_102 == -1 || param2 == false)
         {
            if(param1 >= 1000 && param1 <= 1999)
            {
               ...
               {
                  if(param1 == this.var_83[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return new this.var_83[_loc4_ as any].claType();
                  }
                  _loc4_++;
               }
            }
            if(param1 >= 2000 && param1 <= 2999)
            {
               ...
               {
                  if(param1 == this.var_50[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return new this.var_50[_loc4_ as any].claType();
                  }
                  _loc4_++;
               }
            }
            if(param1 >= 3000 && param1 <= 3999)
            {
               ...
               {
                  if(param1 == this.var_62[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return new this.var_62[_loc4_ as any].claType();
                  }
                  _loc4_++;
               }
            }
            if(param1 >= 4000 && param1 <= 4999)
            {
               ...
               {
                  if(param1 == this.var_48[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return new this.var_48[_loc4_ as any].claType();
                  }
                  _loc4_++;
               }
            }
         ...
         else
         {
            if(param1 >= 1000 && param1 <= 1999)
            {
               return new this.var_83[this.var_104 as any].claType();
            }
            if(param1 >= 2000 && param1 <= 2999)
            {
               return new this.var_50[this.var_104 as any].claType();
            }
            if(param1 >= 3000 && param1 <= 3999)
            {
               return new this.var_62[this.var_104 as any].claType();
            }
            if(param1 >= 4000 && param1 <= 4999)
            {
               return new this.var_48[this.var_104 as any].claType();
            }
         }
         this.var_102 = -1;
         return _loc3_;
      ...
      private method_71(param1: number, param2: boolean = false): any
      {
         var var_102: any;
            ...
            if(param1 >= 1000 && param1 <= 1999)
            {
               ...
               while(_loc4_ < this.var_83.length)
               {
                  if(param1 == this.var_83[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return this.var_83[_loc4_ as any];
                  }
                  _loc4_++;
               }
            }
            if(param1 >= 2000 && param1 <= 2999)
            {
               ...
               while(_loc4_ < this.var_50.length)
               {
                  if(param1 == this.var_50[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return this.var_50[_loc4_ as any];
                  }
                  _loc4_++;
               }
            }
            if(param1 >= 3000 && param1 <= 3999)
            {
               ...
               while(_loc4_ < this.var_62.length)
               {
                  if(param1 == this.var_62[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return this.var_62[_loc4_ as any];
                  }
                  _loc4_++;
               }
            }
            if(param1 >= 4000 && param1 <= 4999)
            {
               ...
               while(_loc4_ < this.var_48.length)
               {
                  if(param1 == this.var_48[_loc4_ as any].intObjID)
                  {
                     this.var_102 = param1;
                     this.var_104 = _loc4_;
                     return this.var_48[_loc4_ as any];
                  }
                  _loc4_++;
               }
            }
         ...
         else
         {
            if(param1 >= 1000 && param1 <= 1999)
            {
               return this.var_83[this.var_104 as any];
            }
            if(param1 >= 2000 && param1 <= 2999)
            {
               return this.var_50[this.var_104 as any];
            }
            if(param1 >= 3000 && param1 <= 3999)
            {
               return this.var_62[this.var_104 as any];
            }
            if(param1 >= 4000 && param1 <= 4999)
            {
               return this.var_48[this.var_104 as any];
            }
         }
         this.var_102 = -1;
         return null;
