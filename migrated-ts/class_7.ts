...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public method_111(param1: number, param2: Function = null, param3: Function = null): any
      {
         var var_94: any;
      ...
      public Destroy(): any
      {
         var var_342: any, var_451: any, var_94: any;

         this.var_342.removeEventListener("keydown", this.Downs.bind(this));
         this.var_342.removeEventListener("keyup", this.Ups.bind(this));
         this.var_451 = false;
         this.var_94.length = 0;
         this.var_94 = null as any;
      }
      ...
      public method_389(param1: number): any
      {
         ...
         {
            if(param1 == this.var_94[_loc3_ as any].KeyCode)
            {
               this.var_94[_loc3_ as any] = this.var_94[this.var_94.length as any];
               var _loc2_: any = this.var_94.pop();
               _loc2_ = null as any;
               break;
            }
            _loc3_ += 1;
      ...
      private Downs(param1: any): any
      {
         ...
         {
            if(param1.keyCode == this.var_94[_loc2_ as any].KeyCode)
            {
               if(this.var_94[_loc2_ as any].CallBackFunctionDown != null)
               {
                  this.var_94[_loc2_ as any].CallBackFunctionDown();
               }
               break;
            }
            _loc2_ += 1;
      ...
      private Ups(param1: any): any
      {
         ...
         while(_loc2_ < this.var_94.length)
         {
            if(param1.keyCode == this.var_94[_loc2_ as any].KeyCode)
            {
               if(this.var_94[_loc2_ as any].CallBackFunctionUp != null)
               {
                  this.var_94[_loc2_ as any].CallBackFunctionUp();
               }
               break;
            }
            _loc2_ += 1;
      ...
      {
         var var_342: any, var_451: any;

         this.var_342.addEventListener("keydown", this.Downs.bind(this));
         this.var_342.addEventListener("keyup", this.Ups.bind(this));
         this.var_451 = true;
      }
   }
