...
import { class_118 } from '../package_11/class_118';
...
export class AGunAreaBurstCannon extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_118 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,12,20,false,{"blnExplode":1});
