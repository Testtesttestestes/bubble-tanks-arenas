...
import { class_128 } from '../package_11/class_128';
...
export class class_148 extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var _loc1_: Point = new (Point as any)(0,0);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var _loc2_: number = 0;
         while(_loc2_ < 360)
         {
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_128 as any)(),_loc1_.x,_loc1_.y,0[9],this.rotation + var_3.rotation + _loc2_,6,0,false,{"blnSticky":1});
            _loc2_ += 360 / 36;
         }
      }
   }
