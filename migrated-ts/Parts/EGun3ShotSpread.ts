...
// @ts-ignore
export class EGun3ShotSpread extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 30,8,2);
         _loc1_ = new (Point as any)(this.emitter2.x,this.emitter2.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,8,2);
