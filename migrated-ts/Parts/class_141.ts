...
import { class_120 } from '../package_11/class_120';
  ...
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         if(intCounter == -1)
         {
            ...
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_120 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,10,2,false);
