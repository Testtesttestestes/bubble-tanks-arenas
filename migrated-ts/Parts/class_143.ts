...
import { class_81 } from '../class_81';
import { class_121 } from '../package_11/class_121';
...
export class class_143 extends Weapon{
  [key: string]: any;
      ...
      public bullet_mc!: MovieClip & Record<string, any>;
      public var_18!: MovieClip & Record<string, any>;
      constructor(){
         // @ts-ignore
         super();
         this.lvEffectLocation = new (class_6 as any)();
         intFireRate = 180;
      }
      ...
      public method_514(): void
      {
         ...
         var _loc1_: Point = new (Point as any)(this.bullet_mc.x,this.bullet_mc.y);
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_121 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,7,100,false);
      }
      ...
      public PartCallTrigger(): void
      {
         ...
         this.bullet_mc.play();
         var_3.objData.objWorld.currentBFTarget.AddEffectToQueue(new (class_81 as any)(),0,0,"BottomEffectsLayer",false,this.method_514);
