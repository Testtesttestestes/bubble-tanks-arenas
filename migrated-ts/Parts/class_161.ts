...
import { class_129 } from '../package_11/class_129';
...
export class class_161 extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_129 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,6,0,true,{"blnSticky":1});
      }
   }
