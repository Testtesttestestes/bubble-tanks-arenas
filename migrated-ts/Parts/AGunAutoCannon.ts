...
export class AGunAutoCannon extends Weapon{
  [key: string]: any;
      ...
      public var_18!: MovieClip & Record<string, any>;
      constructor(){
         // @ts-ignore
         super();
         intFireRate = 18;
      ...
      public AimAutoWeapon(): void
      {
         ...
         (_loc2_ as any).x = this.var_210.x - _loc1_.x;
         (_loc2_ as any).y = this.var_210.y - _loc1_.y;
         var _loc3_: number = Math.round(_loc2_.method_41() / 10);
         var _loc4_: Point = this.var_210.PredictTargetLocation(_loc3_);
         if(_loc4_ == null)
         {
            this.var_210 = null as any;
            return;
         }
         (_loc2_ as any).x = _loc4_.x - _loc1_.x;
         (_loc2_ as any).y = _loc4_.y - _loc1_.y;
         (this as any).rotation = _loc2_.method_90() - var_3.rotation;
      }
      ...
      {
         var var_210: any, var_18: any, var_3: any;

         var _loc1_: Point = null as any;
         if(this.var_210 != null)
         {
            _loc1_ = new (Point as any)(this.var_18.x,this.var_18.y);
      ...
      public method_766(): void
      {
         ...
         _loc1_ = this.parent.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var _loc2_: any = var_3.objData.objWorld.currentBFTarget.arrEnemies;
         var _loc3_: number = 999999999999;
         var _loc4_: number = -1;
         var _loc5_: number = 0;
         while(_loc5_ < _loc2_.length)
         {
            _loc6_ = _loc2_[_loc5_ as any].x - _loc1_.x;
            _loc7_ = _loc2_[_loc5_ as any].y - _loc1_.y;
         ...
         if(_loc4_ != -1)
         {
            this.var_210 = _loc2_[_loc4_ as any];
         }
         else
         {
            this.var_210 = null as any;
