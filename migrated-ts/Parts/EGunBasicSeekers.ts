...
export class EGunBasicSeekers extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_126 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,5,2,true,null,var_3.objData.objWorld.myAvatar);
      }
   }
