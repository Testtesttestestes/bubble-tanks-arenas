...
import { class_123 } from '../package_11/class_123';
...
// @ts-ignore
export class class_144 extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         if(intCounter == -1)
         {
            ...
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_123 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,14,15,false);
