...
import { class_108 } from '../class_108';
...
// @ts-ignore
export class class_152 extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var _loc2_: class_6 = new (class_6 as any)(_loc1_.x,_loc1_.y);
         var_3.objData.objWorld.currentBFTarget.AddEffectToQueue(new (class_108 as any)(),_loc1_.x,_loc1_.y,"BottomEffectsLayer",false);
         (_loc1_ as any).x = stage.mouseX;
         (_loc1_ as any).y = stage.mouseY;
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var _loc3_: class_6 = new (class_6 as any)();
         if(_loc1_.length > var_3.objData.objWorld.currentBFTarget.BF_BG_mc.width / 2)
         {
            (_loc3_ as any).x = _loc1_.x;
            (_loc3_ as any).y = _loc1_.y;
            _loc3_.method_189();
            _loc3_.method_84(var_3.objData.objWorld.currentBFTarget.BF_BG_mc.width / 2);
            (_loc1_ as any).x = _loc3_.x;
            (_loc1_ as any).y = _loc3_.y;
         }
         var_3.objData.objWorld.currentBFTarget.AddEffectToQueue(new (class_108 as any)(),_loc1_.x,_loc1_.y,"BottomEffectsLayer",false);
         var_3.objData.objWorld.mRef.sEffects.FLASH();
         (_loc2_ as any).x = _loc1_.x - _loc2_.x;
         (_loc2_ as any).y = _loc1_.y - _loc2_.y;
