...
import { effect_convert } from '../effect_convert';
...
export class AGunConversion extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.AddEffectToQueue(new (effect_convert as any)(),_loc1_.x,_loc1_.y,"BottomEffectsLayer",false);
