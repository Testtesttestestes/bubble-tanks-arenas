...
export class class_158 extends Weapon{
  [key: string]: any;
      ...
      constructor(){
    var var_389: any, var_436: any, var_301: any;
    ...
    super();
      ...
      public PartCallTrigger(): void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1[8],this.rotation + var_3.rotation,6,4);
      }
