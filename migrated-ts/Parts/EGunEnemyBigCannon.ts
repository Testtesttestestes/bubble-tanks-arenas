...
// @ts-ignore
export class EGunEnemyBigCannon extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var _loc1_: Point = new (Point as any)(this.var_18.x,this.var_18.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,2[5],this.rotation + var_3.rotation,5,4);
      }
   }
