...
import { class_105 } from '../class_105';
import { class_106 } from '../class_106';
import { class_107 } from '../class_107';
  ...
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         if(this.var_293 == -1)
         {
            ...
            this.var_293 *= 2;
            var_3.movShieldHit = new (class_106 as any)();
            var_3.addChild(var_3.movShieldHit);
            (var_3.movShieldHit as any).width = (var_3.movShieldHit as any).height = this.var_293;
            var_3.movShieldHit.gotoAndStop(var_3.movShieldHit.totalFrames);
         }
         this.var_290 = new (class_107 as any)();
         (this.var_290 as any).width = (this.var_290 as any).height = this.var_293;
         var_3.addChild(this.var_290);
         var_3.blnShieled = true;
         var_3.objData.objWorld.currentBFTarget.AddEffectToQueue(new (class_105 as any)(),0,0,"TopEffectsLayer",false,this.KillShield);
         intCounter = intFireRate;
      }
      
      public KillShield(): any
      {
         var var_3: any, var_290: any;

         var_3.removeChild(this.var_290);
         this.var_290 = null as any;
