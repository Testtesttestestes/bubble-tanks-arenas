...
import { class_131 } from '../class_131';
...
export class EGun350Spread extends Weapon{
  [key: string]: any;
      ...
      public emitter1!: MovieClip & Record<string, any>;
      public emitter2!: MovieClip & Record<string, any>;
      public emitter3!: MovieClip & Record<string, any>;
      public emitter5!: MovieClip & Record<string, any>;
      public emitter7!: MovieClip & Record<string, any>;
      public emitter8!: MovieClip & Record<string, any>;
      public emitter9!: MovieClip & Record<string, any>;
      public emitter10!: MovieClip & Record<string, any>;
      public emitter6!: MovieClip & Record<string, any>;
      public emitter4!: MovieClip & Record<string, any>;
      constructor(){
         var var_137: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var _loc1_: Point = new (Point as any)(this.emitter9.x,this.emitter9.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 144,7,2);
         _loc1_ = new (Point as any)(this.emitter10.x,this.emitter10.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 108,7,2);
         _loc1_ = new (Point as any)(this.emitter1.x,this.emitter1.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 72,7,2);
         _loc1_ = new (Point as any)(this.emitter2.x,this.emitter2.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 36,7,2);
         _loc1_ = new (Point as any)(this.emitter3.x,this.emitter3.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,7,2);
         _loc1_ = new (Point as any)(this.emitter4.x,this.emitter4.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation + 36,7,2);
         _loc1_ = new (Point as any)(this.emitter5.x,this.emitter5.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation + 72,7,2);
         _loc1_ = new (Point as any)(this.emitter6.x,this.emitter6.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation + 108,7,2);
         _loc1_ = new (Point as any)(this.emitter7.x,this.emitter7.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation + 144,7,2);
         _loc1_ = new (Point as any)(this.emitter8.x,this.emitter8.y);
         _loc1_ = this.localToGlobal(_loc1_);
         _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_131 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation + 180,7,2);
      }
   }
