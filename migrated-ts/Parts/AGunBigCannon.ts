...
// @ts-ignore
export class AGunBigCannon extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         if(intCounter == -1)
         {
            ...
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_130 as any)(),_loc1_.x,_loc1_.y,2[5],this.rotation + var_3.rotation,8,3,false);
