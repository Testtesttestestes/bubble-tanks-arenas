...
import { class_130 } from '../class_130';
...
// @ts-ignore
export class AGun5ShotSpread extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         if(intCounter == -1)
         {
            ...
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_130 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 20,10,1,false);
            _loc1_ = new (Point as any)(this.emitter2.x,this.emitter2.y);
            _loc1_ = this.localToGlobal(_loc1_);
            _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_130 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 10,10,1,false);
            _loc1_ = new (Point as any)(this.emitter3.x,this.emitter3.y);
            _loc1_ = this.localToGlobal(_loc1_);
            _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_130 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation,10,1,false);
