...
// @ts-ignore
export class AGun3ShotSpread extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         if(intCounter == -1)
         {
            ...
            _loc1_ = this.localToGlobal(_loc1_);
            _loc1_ = var_3.objData.objWorld.currentBFTarget.globalToLocal(_loc1_);
            var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_130 as any)(),_loc1_.x,_loc1_.y,1,this.rotation + var_3.rotation - 30,10,1,false);
