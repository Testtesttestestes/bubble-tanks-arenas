...
import { class_127 } from '../package_11/class_127';
...
export class class_147 extends Weapon{
  [key: string]: any;
      ...
      public PartCallTrigger(): void
      {
         ...
         var_3.objData.objWorld.currentBFTarget.SpawnNewBullet(new (class_127 as any)(),_loc1_.x,_loc1_.y,1[7],this.rotation + var_3.rotation,8,35,false);
      }
   }
