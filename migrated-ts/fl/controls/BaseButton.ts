...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(){
         ...
         this.pressTimer = new (Timer as any)(1,0);
         this.pressTimer.addEventListener(TimerEvent.TIMER, this.buttonDown.bind(this));
      }
      ...
      protected startPress(): void
      {
         ...
         this.dispatchEvent(new (ComponentEvent as any)(ComponentEvent.BUTTON_DOWN,true));
      }
      ...
      protected mouseEventHandler(param1: any): void
      {
         ...
         else if(param1.type == "mouseover" || param1.type == "mouseup")
         {
      ...
      {
         var _loc1_: string = this.enabled ? mouseState : "disabled";
         if(selected)
         {
      ...
      {
         this.addEventListener("mouseover", this.mouseEventHandler.bind(this));
         this.addEventListener("mousedown", this.mouseEventHandler.bind(this));
         this.addEventListener("mouseup", this.mouseEventHandler.bind(this));
         this.addEventListener("mouseout", this.mouseEventHandler.bind(this));
      }
      ...
      protected buttonDown(param1: any): void
      {
         if(!this._autoRepeat)
         {
            this.endPress();
