...
export class Button extends LabelButton implements IFocusManagerComponent
  ...
  [key: string]: any;
      ...
      {
         return UIComponent.mergeStyles(LabelButton.getStyleDefinition(),Button.defaultStyles);
      }
      ...
      protected drawEmphasized(): void
      {
         ...
         this.emphasizedBorder = null as any;
         if(!this._emphasized)
         {
            return;
         }
         var _loc1_: any = getStyleValue("emphasizedSkin");
         if(_loc1_ != null)
         {
         ...
         if(emphasizedBorder != null)
         {
            ...
            (emphasizedBorder as any).x = (emphasizedBorder as any).y = -_loc2_;
            (emphasizedBorder as any).width = width + _loc2_ * 2;
            (emphasizedBorder as any).height = height + _loc2_ * 2;
         }
      }
      ...
      public drawFocus(param1: boolean): void
      {
         ...
         if(param1)
         {
            ...
            _loc3_ += _loc2_;
            (uiFocusRect as any).x = -_loc3_;
            (uiFocusRect as any).y = -_loc3_;
            (uiFocusRect as any).width = width + _loc3_ * 2;
            (uiFocusRect as any).height = height + _loc3_ * 2;
         }
      }
   }
