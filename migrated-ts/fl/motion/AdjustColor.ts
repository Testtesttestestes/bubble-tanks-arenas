...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      private CalculateFinalMatrix(): boolean
      {
         ...
         this.m_finalMatrix = new (ColorMatrix as any)();
      ...
      public set brightness(param1: number)
      {
         ...
         {
            this.m_brightnessMatrix = new (ColorMatrix as any)();
         }
         if(param1 != 0)
         {
      ...
      public set contrast(param1: number)
      {
         ...
         {
            _loc2_ = AdjustColor.s_arrayOfDeltaIndex[int(param1) as any] * 127 + 127;
         }
         else
         {
         ...
         {
            this.m_contrastMatrix = new (ColorMatrix as any)();
         }
         this.m_contrastMatrix.SetContrastMatrix(_loc2_);
      }
      
      public set hue(param1: number)
      {
         if(this.m_hueMatrix == null)
         {
            this.m_hueMatrix = new (ColorMatrix as any)();
         }
         if(param1 != 0)
         {
      ...
      public CalculateFinalFlatArray(): any
      {
      ...
      public set saturation(param1: number)
      {
         var _loc2_: number = param1;
         if(param1 == 0)
         {
         ...
         {
            this.m_saturationMatrix = new (ColorMatrix as any)();
         }
