...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      public Add(param1: DynamicMatrix): boolean
      {
         ...
         var _loc2_: number = param1.GetHeight();
         var _loc3_: number = param1.GetWidth();
         ...
         while(_loc4_ < this.m_height)
         {
            ...
            {
               _loc6_ = 0;
               _loc6_ = this.m_matrix[_loc4_ as any][_loc5_] + param1.GetValue(_loc4_,_loc5_);
               this.m_matrix[_loc4_ as any][_loc5_] = _loc6_;
               _loc5_++;
            }
            _loc4_++;
         }
         ...
         if(this.m_matrix)
         {
            ...
            while(_loc1_ < this.m_height)
            {
               ...
               while(_loc2_ < this.m_width)
               {
                  if(_loc1_ == _loc2_)
                  {
                     this.m_matrix[_loc1_ as any][_loc2_] = 1;
                  }
                  else
                  {
                     this.m_matrix[_loc1_ as any][_loc2_] = 0;
                  }
                  _loc2_++;
               }
               _loc1_++;
      ...
      {
         var _loc5_: DynamicMatrix = null as any;
         var _loc6_: number = 0;
         var _loc7_: number = 0;
         ...
         var _loc3_: number = param1.GetHeight();
         var _loc4_: number = param1.GetWidth();
         if(param2 == DynamicMatrix.MATRIX_ORDER_APPEND)
         {
            if(this.m_width != _loc3_)
            {
               return false;
            }
            _loc5_ = new (DynamicMatrix as any)(_loc4_,this.m_height);
            _loc6_ = 0;
            while(_loc6_ < this.m_height)
            {
               ...
               while(_loc7_ < _loc4_)
               {
                  ...
                  {
                     _loc8_ += param1.GetValue(_loc9_,_loc7_) * this.m_matrix[_loc6_ as any][_loc10_];
                     _loc9_++;
                     _loc10_++;
                  }
            ...
            while(_loc6_ < _loc3_)
            {
               ...
               {
                  this.m_matrix[_loc6_ as any][_loc7_] = _loc5_.GetValue(_loc6_,_loc7_);
                  _loc7_++;
               }
               _loc6_++;
            }
         ...
         else
         {
            ...
            _loc5_ = new (DynamicMatrix as any)(this.m_width,_loc3_);
            _loc6_ = 0;
            while(_loc6_ < _loc3_)
            {
               _loc7_ = 0;
               while(_loc7_ < this.m_width)
               {
                  ...
                  {
                     _loc8_ += this.m_matrix[_loc9_ as any][_loc7_] * param1.GetValue(_loc6_,_loc10_);
                     _loc9_++;
                     _loc10_++;
                  }
                  _loc5_.SetValue(_loc6_,_loc7_,_loc8_);
      ...
      public MultiplyNumber(param1: number): boolean
      {
         ...
         while(_loc2_ < this.m_height)
         {
            ...
            {
               _loc4_ = 0;
               _loc4_ = this.m_matrix[_loc2_ as any][_loc3_] * param1;
               this.m_matrix[_loc2_ as any][_loc3_] = _loc4_;
               _loc3_++;
            }
            _loc2_++;
         }
      ...
      public SetValue(param1: number, param2: number, param3: number): void
      {
         ...
         {
            this.m_matrix[param1 as any][param2] = param3;
         }
      }
      ...
      public GetValue(param1: number, param2: number): number
      {
         ...
         if(param1 >= 0 && param1 < this.m_height && param2 >= 0 && param2 <= this.m_width)
         {
            _loc3_ = Number(this.m_matrix[param1 as any][param2]);
         }
         return _loc3_;
      }
      ...
      protected Create(param1: number, param2: number): void
      {
         ...
         if(param1 > 0 && param2 > 0)
         {
            ...
            this.m_matrix = new (Array as any)(param2);
            _loc3_ = 0;
            while(_loc3_ < param2)
            {
               this.m_matrix[_loc3_ as any] = new (Array as any)(param1);
               _loc4_ = 0;
               while(_loc4_ < param2)
               {
                  this.m_matrix[_loc3_ as any][_loc4_] = 0;
                  _loc4_++;
               }
               _loc3_++;
            }
