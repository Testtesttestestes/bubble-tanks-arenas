...
// @ts-ignore
  ...
  [key: string]: any;
      ...
      constructor(param1: string, param2: boolean = false, param3: boolean = false, param4: number = -1, param5: number = -1, param6: number = -1, param7: any = null){
         // @ts-ignore
      ...
      public clone(): any
      {
         return new (ListEvent as any)(type,bubbles,cancelable,_columnIndex,this._rowIndex);
      }
      
      public get rowIndex(): any
      {
