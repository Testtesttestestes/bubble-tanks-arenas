...
export class class_109 extends MovieClip{
      ...
      public AddEffectToQueue(param1: MovieClip, param2: number, param3: number, param4: string, param5: boolean, param6: Function = null as any): void
      {
      ...
      public SpawnNewBullet(param1: class_68, param2: number, param3: number, param4: number, param5: number, param6: number, param7: number, param8: boolean = true, param9: Record<string, any> = null, param10: MovieClip = null as any): class_68
      {
      ...
      {
         let _loc4_: TankData = new TankData();
         _loc4_.ImportTankData(param1);
         let _loc5_: MovieClip = _loc4_.method_61(3,this.var_60);
         _loc5_.x = param2;
         _loc5_.y = param3;
      ...
      private method_589(param1: Record<string, any>): void
      {
         if(this.var_60.var_320 == true)
         {
      ...
      public method_333(param1: class_68): void
      {
         ...
         let var_56: number = 0;
         let var_40: number = 0;
         let var_157: number = 0;
         let var_126: class_68 = param1;
      ...
      {
         let _loc4_: number = param1.x - param2.x;
         let _loc5_: number = param1.y - param2.y;
         param3 *= 1.15;
